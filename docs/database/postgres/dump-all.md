Title: PostgreSQL: Documentation: 17: 25.1. SQL Dump                
...
| 25.1. SQL Dump |
| :-: |
| Prev  | Up | Chapter 25. Backup and Restore | Home |  Next |
...
pg\_dump _`dbname`_ > _`dumpfile`_
...
psql -X _`dbname`_ < _`dumpfile`_
...
psql -X --set ON\_ERROR\_STOP=on _`dbname`_ < _`dumpfile`_
...
pg\_dump -h _`host1`_ _`dbname`_ | psql -X -h _`host2`_ _`dbname`_
...
pg\_dumpall > _`dumpfile`_

The resulting dump can be restored with psql:

psql -X -f _`dumpfile`_ postgres
...
pg\_dump _`dbname`_ | gzip > _`filename`_.gz

Reload with:

gunzip -c _`filename`_.gz | psql _`dbname`_

or:

cat _`filename`_.gz | gunzip | psql _`dbname`_
...
pg\_dump _`dbname`_ | split -b 2G - _`filename`_

Reload with:

cat _`filename`_\* | psql _`dbname`_

If using GNU split, it is possible to use it and gzip together:

pg\_dump _`dbname`_ | split -b 2G --filter='gzip > $FILE.gz'
...
pg\_dump -j _`num`_ -F d -f _`out.dir`_ _`dbname`_
...
<table><tbody><tr><td><a accesskey="p" href="backup.html" title="Chapter&nbsp;25.&nbsp;Backup and Restore">Prev</a>&nbsp;</td><td><a accesskey="u" href="backup.html" title="Chapter&nbsp;25.&nbsp;Backup and Restore">Up</a></td><td>&nbsp;<a accesskey="n" href="backup-file.html" title="25.2.&nbsp;File System Level Backup">Next</a></td></tr><tr><td>Chapter&nbsp;25.&nbsp;Backup and Restore&nbsp;</td><td><a accesskey="h" href="index.html" title="PostgreSQL 17.5 Documentation">Home</a></td><td>&nbsp;25.2.&nbsp;File System Level Backup</td></tr></tbody></table>
