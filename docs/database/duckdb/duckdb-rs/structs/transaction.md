# Transaction in duckdb - Rust

## Struct Transaction 

[Source](about:blank/src/duckdb/transaction.rs.html#45-48)
...
[Source](about:blank/src/duckdb/transaction.rs.html#50-134)
[§](#impl-Transaction%3C'_%3E)

[Source](about:blank/src/duckdb/transaction.rs.html#57-59)

Begin a new transaction. Cannot be nested.

Even though we don’t mutate the connection, we take a `&mut Connection` so as to prevent nested transactions on the same connection. For cases where this is unacceptable, [`Transaction::new_unchecked`](about:blank/struct.Transaction.html#method.new_unchecked "associated function duckdb::Transaction::new_unchecked") is available.

[Source](about:blank/src/duckdb/transaction.rs.html#67-73)

Begin a new transaction, failing if a transaction is open.

If a transaction is already open, this will return an error. Where possible, [`Transaction::new`](about:blank/struct.Transaction.html#method.new "associated function duckdb::Transaction::new") should be preferred, as it provides a compile-time guarantee that transactions are not nested.

[Source](about:blank/src/duckdb/transaction.rs.html#78-80)

Get the current setting for what happens to the transaction when it is dropped.

[Source](about:blank/src/duckdb/transaction.rs.html#85-87)

Configure the transaction to perform the specified action when it is dropped.

[Source](about:blank/src/duckdb/transaction.rs.html#91-93)

A convenience method which consumes and commits a transaction.

[Source](about:blank/src/duckdb/transaction.rs.html#102-104)

A convenience method which consumes and rolls back a transaction.

[Source](about:blank/src/duckdb/transaction.rs.html#117-119)
...
[§](#impl-Freeze-for-Transaction%3C'conn%3E)

[§](#impl-RefUnwindSafe-for-Transaction%3C'conn%3E)

[§](#impl-Send-for-Transaction%3C'conn%3E)

[§](#impl-Sync-for-Transaction%3C'conn%3E)

[§](#impl-Unpin-for-Transaction%3C'conn%3E)

[§](#impl-UnwindSafe-for-Transaction%3C'conn%3E)
