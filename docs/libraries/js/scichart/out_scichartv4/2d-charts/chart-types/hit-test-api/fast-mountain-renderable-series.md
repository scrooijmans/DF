...
## The hitTest method on Mountain Series<a href="https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/hit-test-api/fast-mountain-renderable-series/#the-hittest-method-on-mountain-series" class="hash-link" aria-label="Direct link to The hitTest method on Mountain Series" translate="no" title="Direct link to The hitTest method on Mountain Series">â€‹</a>

The **IHitTestProvider.hitTest** method onÂ [FastMountainRenderableSeries](https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/hit-test-api/fast-mountain-renderable-series) tests if the click was within the mountain body.
...
<img src="out_scichartv4/2d-charts/chart-types/hit-test-api/fast-mountain-renderable-series/index_media/35c725fbe4963ab7285f4d42170155a3767a9c00.png" style="display:block;margin-left:auto;margin-right:auto;object-fit:contain;height:auto;width:85%;margin:0 auto" />

Â If to click inside the mountain it will be hit. In the browser console you will find output for the **HitTestInfo** object.

## The hitTestDataPoint method on Mountain Series<a href="https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/hit-test-api/fast-mountain-renderable-series/#the-hittestdatapoint-method-on-mountain-series" class="hash-link" aria-label="Direct link to The hitTestDataPoint method on Mountain Series" translate="no" title="Direct link to The hitTestDataPoint method on Mountain Series">â€‹</a>

The **IHitTestProvider.hitTestDataPoint** method onÂ [FastMountainRenderableSeries](https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/fast-mountain-area-renderable-series) tests if the click was within the **hitTestRadius** from a data point.
...
## The hitTestXSlice method on Mountain Series<a href="https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/hit-test-api/fast-mountain-renderable-series/#the-hittestxslice-method-on-mountain-series" class="hash-link" aria-label="Direct link to The hitTestXSlice method on Mountain Series" translate="no" title="Direct link to The hitTestXSlice method on Mountain Series">â€‹</a>
...
#### See Also<a href="https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/hit-test-api/fast-mountain-renderable-series/#see-also" class="hash-link" aria-label="Direct link to See Also" translate="no" title="Direct link to See Also">â€‹</a>
...
<a href="https://github.com/ABTSoftware/SciChart.JS.Docs/tree/dev/docusaurus/docs/2d-charts/chart-types/hit-test-api/fast-mountain-renderable-series/index.md" class="theme-edit-this-page" rel="noopener noreferrer" target="_blank"><img src="out_scichartv4/2d-charts/chart-types/hit-test-api/fast-mountain-renderable-series/index_media/42a87493f9569d393738cbffa7bed03324e68916.svg" class="iconEdit_Z9Sw" />Edit this page</a>
