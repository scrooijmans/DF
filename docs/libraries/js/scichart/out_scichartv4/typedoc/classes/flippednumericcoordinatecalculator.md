<img src="out_scichartv4/typedoc/classes/flippednumericcoordinatecalculator_media/d804b495cb9b84b9007a25b5d85f9ae674004cde.gif" style="display:none;" width="1" height="1" />
...
<a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html#" class="tsd-widget options no-caption" data-toggle="options">Options</a>
...
- [FlippedNumericCoordinateCalculator](https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html)
...
Provides an implementation of Numeric [Coordinate Calculator](https://www.scichart.com/documentation/js/v4/typedoc/classes/coordinatecalculatorbase.html) which transforms numeric data-values to pixel coordinates and vice versa. This implementation provides flipped coordinates relative to [NumericCoordinateCalculator](https://www.scichart.com/documentation/js/v4/typedoc/classes/numericcoordinatecalculator.html)
...
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html#constructor" class="tsd-kind-icon">constructor</a>

### Properties

- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html#hasflippedcoordinates" class="tsd-kind-icon">hasFlippedCoordinates</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html#iscategorycoordinatecalculator" class="tsd-kind-icon">isCategoryCoordinateCalculator</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html#nativecalculator" class="tsd-kind-icon">nativeCalculator</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html#offset" class="tsd-kind-icon">offset</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html#viewportdimension" class="tsd-kind-icon">viewportDimension</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html#visiblemax" class="tsd-kind-icon">visibleMax</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html#visiblemin" class="tsd-kind-icon">visibleMin</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html#webassemblycontext" class="tsd-kind-icon">webAssemblyContext</a>

### Accessors

- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html#isflipped" class="tsd-kind-icon">isFlipped</a>

### Methods

- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html#delete" class="tsd-kind-icon">delete</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html#getcoordwidth" class="tsd-kind-icon">getCoordWidth</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html#getcoordinate" class="tsd-kind-icon">getCoordinate</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html#getdatavalue" class="tsd-kind-icon">getDataValue</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html#getdatawidth" class="tsd-kind-icon">getDataWidth</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html#translateby" class="tsd-kind-icon">translateBy</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html#zoomtranslateby" class="tsd-kind-icon">zoomTranslateBy</a>

## Constructors

### constructor

- new FlippedNumericCoordinateCalculator(webAssemblyContext: <a href="https://www.scichart.com/documentation/js/v4/typedoc/index.html#tscichart" class="tsd-signature-type">TSciChart</a> \| <a href="https://www.scichart.com/documentation/js/v4/typedoc/index.html#tscichart3d" class="tsd-signature-type">TSciChart3D</a>, viewportDimension: number, visibleMin: number, visibleMax: number, offset?: number, allowFastMath?: boolean, viewportOffset?: number): <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html" class="tsd-signature-type">FlippedNumericCoordinateCalculator</a>
...
- Creates an instance of FlippedNumericCoordinateCalculator
  ...
  - ##### Default value allowFastMath: boolean = false

    When true, calculate using 32-bit floating point values (faster, but less accurate)

  - ##### Default value viewportOffset: number = -1

  #### Returns <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html" class="tsd-signature-type">FlippedNumericCoordinateCalculator</a>
...
- Converts the Data-value to a pixel coordinate Performs the inverse operation to [getDataValue](https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html#getdatavalue)
...
- Converts the pixel coordinate to a Data-value. Performs the inverse operation to [getCoordinate](https://www.scichart.com/documentation/js/v4/typedoc/classes/flippednumericcoordinatecalculator.html#getcoordinate)
