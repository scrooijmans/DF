<img src="out_scichartv4/typedoc/classes/surfacemeshsceneentity_media/d804b495cb9b84b9007a25b5d85f9ae674004cde.gif" style="display:none;" width="1" height="1" />
...
<a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#" class="tsd-widget options no-caption" data-toggle="options">Options</a>
...
- [SurfaceMeshSceneEntity](https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html)
...
summary  
[BaseSceneEntity3D](https://www.scichart.com/documentation/js/v4/typedoc/classes/basesceneentity3d.html) type for drawing 3D Surface Plot or Surface Mesh with optional Contours in SciChart's High Performance <a href="https://www.scichart.com/javascript-chart-features" class="external">JavaScript 3D Charts</a>

remarks  
See related type [SurfaceMeshRenderableSeries3D](https://www.scichart.com/documentation/js/v4/typedoc/enums/eseriestype3d.html#surfacemeshrenderableseries3d) which should be added to [SciChart3DSurface.renderableSeries](https://www.scichart.com/documentation/js/v4/typedoc/classes/scichart3dsurface.html#renderableseries) along with data from an [UniformGridDataSeries3D](https://www.scichart.com/documentation/js/v4/typedoc/classes/uniformgriddataseries3d.html) to create a 3D Surface Mesh or Surface Plot

### Hierarchy

- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/renderableseriessceneentity.html" class="tsd-signature-type">RenderableSeriesSceneEntity</a>\<<a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshrenderableseries3d.html" class="tsd-signature-type">SurfaceMeshRenderableSeries3D</a>, <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentitystate.html" class="tsd-signature-type">SurfaceMeshSceneEntityState</a>, SCRTGridMeshEntity\>
...
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#constructor" class="tsd-kind-icon">constructor</a>

### Properties

- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#children" class="tsd-kind-icon">children</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#currentrenderpassdata" class="tsd-kind-icon">currentRenderPassData</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#id" class="tsd-kind-icon">id</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#parent" class="tsd-kind-icon">parent</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#parentseries" class="tsd-kind-icon">parentSeries</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#rootsceneentity" class="tsd-kind-icon">rootSceneEntity</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#state" class="tsd-kind-icon">state</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#type" class="tsd-kind-icon">type</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#webassemblycontext" class="tsd-kind-icon">webAssemblyContext</a>

### Accessors

- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#entityid" class="tsd-kind-icon">entityId</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#entityidprovider" class="tsd-kind-icon">entityIdProvider</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#isvisible" class="tsd-kind-icon">isVisible</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#nativeentity" class="tsd-kind-icon">nativeEntity</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#world" class="tsd-kind-icon">world</a>

### Methods

- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#render" class="tsd-kind-icon">Render</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#update" class="tsd-kind-icon">Update</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#attachchild" class="tsd-kind-icon">attachChild</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#delete" class="tsd-kind-icon">delete</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#detachchild" class="tsd-kind-icon">detachChild</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#getentity" class="tsd-kind-icon">getEntity</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#getroot" class="tsd-kind-icon">getRoot</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#hittest" class="tsd-kind-icon">hitTest</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#hittestxyz" class="tsd-kind-icon">hitTestXyz</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#invalidatescene" class="tsd-kind-icon">invalidateScene</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#notifyseriespropertychanged" class="tsd-kind-icon">notifySeriesPropertyChanged</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#onattached" class="tsd-kind-icon">onAttached</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#ondetached" class="tsd-kind-icon">onDetached</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#ondpichanged" class="tsd-kind-icon">onDpiChanged</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#onenginerestart" class="tsd-kind-icon">onEngineRestart</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#setnativeentity" class="tsd-kind-icon">setNativeEntity</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#setrenderpassdata" class="tsd-kind-icon">setRenderPassData</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#updateseries" class="tsd-kind-icon">updateSeries</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html#visitentities" class="tsd-kind-icon">visitEntities</a>

## Constructors

### constructor

- new SurfaceMeshSceneEntity(webAssemblyContext: <a href="https://www.scichart.com/documentation/js/v4/typedoc/index.html#tscichart3d" class="tsd-signature-type">TSciChart3D</a>, parentSeries: <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshrenderableseries3d.html" class="tsd-signature-type">SurfaceMeshRenderableSeries3D</a>): <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html" class="tsd-signature-type">SurfaceMeshSceneEntity</a>

<!-- -->

- Creates an instance of [SurfaceMeshSceneEntity](https://www.scichart.com/documentation/js/v4/typedoc/enums/esceneentitytype.html#surfacemeshsceneentity)
  ...
  - ##### parentSeries: <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshrenderableseries3d.html" class="tsd-signature-type">SurfaceMeshRenderableSeries3D</a>
  ...
  #### Returns <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentity.html" class="tsd-signature-type">SurfaceMeshSceneEntity</a>
...
state: <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/surfacemeshsceneentitystate.html" class="tsd-signature-type">SurfaceMeshSceneEntityState</a>

### Readonly type

type: <a href="https://www.scichart.com/documentation/js/v4/typedoc/enums/esceneentitytype.html" class="tsd-signature-type">ESceneEntityType</a> = ESceneEntityType.SurfaceMeshSceneEntity
...
- setNativeEntity(entity: SCRTGridMeshEntity): void
