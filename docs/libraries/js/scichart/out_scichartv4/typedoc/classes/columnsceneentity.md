<img src="out_scichartv4/typedoc/classes/columnsceneentity_media/d804b495cb9b84b9007a25b5d85f9ae674004cde.gif" style="display:none;" width="1" height="1" />
...
<a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#" class="tsd-widget options no-caption" data-toggle="options">Options</a>
...
- [ColumnSceneEntity](https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html)

# Class ColumnSceneEntity
...
summary  
[BaseSceneEntity3D](https://www.scichart.com/documentation/js/v4/typedoc/classes/basesceneentity3d.html) type for drawing 3D Column series in SciChart's High Performance <a href="https://www.scichart.com/javascript-chart-features" class="external">JavaScript 3D Charts</a>

remarks  
See related type [ColumnRenderableSeries3D](https://www.scichart.com/documentation/js/v4/typedoc/enums/eseriestype3d.html#columnrenderableseries3d) which should be added to [SciChart3DSurface.renderableSeries](https://www.scichart.com/documentation/js/v4/typedoc/classes/scichart3dsurface.html#renderableseries) along with data from an [XyzDataSeries3D](https://www.scichart.com/documentation/js/v4/typedoc/classes/xyzdataseries3d.html) to create a 3D Column chart

### Hierarchy

- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/renderableseriessceneentity.html" class="tsd-signature-type">RenderableSeriesSceneEntity</a>\<<a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnrenderableseries3d.html" class="tsd-signature-type">ColumnRenderableSeries3D</a>, <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/renderableseriessceneentitystate.html" class="tsd-signature-type">RenderableSeriesSceneEntityState</a>, SCRTColumnsSceneEntity\>
  - ColumnSceneEntity
...
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#constructor" class="tsd-kind-icon">constructor</a>

### Properties

- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#children" class="tsd-kind-icon">children</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#currentrenderpassdata" class="tsd-kind-icon">currentRenderPassData</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#id" class="tsd-kind-icon">id</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#parent" class="tsd-kind-icon">parent</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#parentseries" class="tsd-kind-icon">parentSeries</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#rootsceneentity" class="tsd-kind-icon">rootSceneEntity</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#state" class="tsd-kind-icon">state</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#type" class="tsd-kind-icon">type</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#webassemblycontext" class="tsd-kind-icon">webAssemblyContext</a>

### Accessors

- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#entityid" class="tsd-kind-icon">entityId</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#entityidprovider" class="tsd-kind-icon">entityIdProvider</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#isvisible" class="tsd-kind-icon">isVisible</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#nativeentity" class="tsd-kind-icon">nativeEntity</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#world" class="tsd-kind-icon">world</a>

### Methods

- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#render" class="tsd-kind-icon">Render</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#update" class="tsd-kind-icon">Update</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#attachchild" class="tsd-kind-icon">attachChild</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#delete" class="tsd-kind-icon">delete</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#detachchild" class="tsd-kind-icon">detachChild</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#getentity" class="tsd-kind-icon">getEntity</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#getroot" class="tsd-kind-icon">getRoot</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#hittest" class="tsd-kind-icon">hitTest</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#hittestxyz" class="tsd-kind-icon">hitTestXyz</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#invalidatescene" class="tsd-kind-icon">invalidateScene</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#notifyseriespropertychanged" class="tsd-kind-icon">notifySeriesPropertyChanged</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#onattached" class="tsd-kind-icon">onAttached</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#ondetached" class="tsd-kind-icon">onDetached</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#ondpichanged" class="tsd-kind-icon">onDpiChanged</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#onenginerestart" class="tsd-kind-icon">onEngineRestart</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#setnativeentity" class="tsd-kind-icon">setNativeEntity</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#setrenderpassdata" class="tsd-kind-icon">setRenderPassData</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#updateseries" class="tsd-kind-icon">updateSeries</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html#visitentities" class="tsd-kind-icon">visitEntities</a>

## Constructors

### constructor

- new ColumnSceneEntity(webAssemblyContext: <a href="https://www.scichart.com/documentation/js/v4/typedoc/index.html#tscichart3d" class="tsd-signature-type">TSciChart3D</a>, parentSeries: <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnrenderableseries3d.html" class="tsd-signature-type">ColumnRenderableSeries3D</a>): <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html" class="tsd-signature-type">ColumnSceneEntity</a>

<!-- -->

- Creates an instance of [ColumnSceneEntity](https://www.scichart.com/documentation/js/v4/typedoc/enums/esceneentitytype.html#columnsceneentity)
  ...
  - ##### parentSeries: <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnrenderableseries3d.html" class="tsd-signature-type">ColumnRenderableSeries3D</a>
  ...
  #### Returns <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/columnsceneentity.html" class="tsd-signature-type">ColumnSceneEntity</a>
...
type: <a href="https://www.scichart.com/documentation/js/v4/typedoc/enums/esceneentitytype.html" class="tsd-signature-type">ESceneEntityType</a> = ESceneEntityType.ColumnSceneEntity
...
- get nativeEntity(): SCRTColumnsSceneEntity
...
- Gets the native [SCRTSceneEntity](https://www.scichart.com/documentation/js/v4/typedoc/enums/esceneentitytype.html#scrtsceneentity) - a WebAssembly 3D Scene Entity type which is passed to our WebGL WebAssembly 3D Engine
  ...
  #### Returns SCRTColumnsSceneEntity
...
- setNativeEntity(entity: SCRTColumnsSceneEntity): void
