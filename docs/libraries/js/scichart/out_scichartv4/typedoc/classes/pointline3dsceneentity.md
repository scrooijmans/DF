<img src="out_scichartv4/typedoc/classes/pointline3dsceneentity_media/d804b495cb9b84b9007a25b5d85f9ae674004cde.gif" style="display:none;" width="1" height="1" />
...
<a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#" class="tsd-widget options no-caption" data-toggle="options">Options</a>
...
- [PointLine3DSceneEntity](https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html)

# Class PointLine3DSceneEntity
...
summary  
[BaseSceneEntity3D](https://www.scichart.com/documentation/js/v4/typedoc/classes/basesceneentity3d.html) type for drawing 3D Scatter or Bubble series in SciChart's High Performance <a href="https://www.scichart.com/javascript-chart-features" class="external">JavaScript 3D Charts</a>

remarks  
See related type [ScatterRenderableSeries3D](https://www.scichart.com/documentation/js/v4/typedoc/enums/eseriestype3d.html#scatterrenderableseries3d) which should be added to [SciChart3DSurface.renderableSeries](https://www.scichart.com/documentation/js/v4/typedoc/classes/scichart3dsurface.html#renderableseries) along with data from an [XyzDataSeries3D](https://www.scichart.com/documentation/js/v4/typedoc/classes/xyzdataseries3d.html) to create a 3D Scatter or Bubble chart

### Hierarchy

- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/renderableseriessceneentity.html" class="tsd-signature-type">RenderableSeriesSceneEntity</a>\<<a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointlinerenderableseries3d.html" class="tsd-signature-type">PointLineRenderableSeries3D</a>, <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/renderableseriessceneentitystate.html" class="tsd-signature-type">RenderableSeriesSceneEntityState</a>, SCRTPointLine3DSceneEntity\>
...
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/interfaces/irenderableseriessceneentity.html" class="tsd-signature-type">IRenderableSeriesSceneEntity</a>

## Index

### Constructors

- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#constructor" class="tsd-kind-icon">constructor</a>

### Properties

- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#children" class="tsd-kind-icon">children</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#currentrenderpassdata" class="tsd-kind-icon">currentRenderPassData</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#id" class="tsd-kind-icon">id</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#parent" class="tsd-kind-icon">parent</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#parentseries" class="tsd-kind-icon">parentSeries</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#rootsceneentity" class="tsd-kind-icon">rootSceneEntity</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#state" class="tsd-kind-icon">state</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#type" class="tsd-kind-icon">type</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#webassemblycontext" class="tsd-kind-icon">webAssemblyContext</a>

### Accessors

- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#entityid" class="tsd-kind-icon">entityId</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#entityidprovider" class="tsd-kind-icon">entityIdProvider</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#isvisible" class="tsd-kind-icon">isVisible</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#nativeentity" class="tsd-kind-icon">nativeEntity</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#world" class="tsd-kind-icon">world</a>

### Methods

- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#render" class="tsd-kind-icon">Render</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#update" class="tsd-kind-icon">Update</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#attachchild" class="tsd-kind-icon">attachChild</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#delete" class="tsd-kind-icon">delete</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#detachchild" class="tsd-kind-icon">detachChild</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#getentity" class="tsd-kind-icon">getEntity</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#getroot" class="tsd-kind-icon">getRoot</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#hittest" class="tsd-kind-icon">hitTest</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#hittestxyz" class="tsd-kind-icon">hitTestXyz</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#invalidatescene" class="tsd-kind-icon">invalidateScene</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#notifyseriespropertychanged" class="tsd-kind-icon">notifySeriesPropertyChanged</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#onattached" class="tsd-kind-icon">onAttached</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#ondetached" class="tsd-kind-icon">onDetached</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#ondpichanged" class="tsd-kind-icon">onDpiChanged</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#onenginerestart" class="tsd-kind-icon">onEngineRestart</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#setnativeentity" class="tsd-kind-icon">setNativeEntity</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#setrenderpassdata" class="tsd-kind-icon">setRenderPassData</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#updateseries" class="tsd-kind-icon">updateSeries</a>
- <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html#visitentities" class="tsd-kind-icon">visitEntities</a>

## Constructors

### constructor

- new PointLine3DSceneEntity(webAssemblyContext: <a href="https://www.scichart.com/documentation/js/v4/typedoc/index.html#tscichart3d" class="tsd-signature-type">TSciChart3D</a>, parentSeries: <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointlinerenderableseries3d.html" class="tsd-signature-type">PointLineRenderableSeries3D</a>): <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html" class="tsd-signature-type">PointLine3DSceneEntity</a>

<!-- -->

- Creates an instance of [ScatterPointsSceneEntity](https://www.scichart.com/documentation/js/v4/typedoc/enums/esceneentitytype.html#scatterpointssceneentity)
  ...
  - ##### parentSeries: <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointlinerenderableseries3d.html" class="tsd-signature-type">PointLineRenderableSeries3D</a>

    The parent [BaseRenderableSeries3D](https://www.scichart.com/documentation/js/v4/typedoc/classes/baserenderableseries3d.html) which this entity maps to

  #### Returns <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/pointline3dsceneentity.html" class="tsd-signature-type">PointLine3DSceneEntity</a>
...
state: <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/renderableseriessceneentitystate.html" class="tsd-signature-type">RenderableSeriesSceneEntityState</a>

### Readonly type

type: <a href="https://www.scichart.com/documentation/js/v4/typedoc/enums/esceneentitytype.html" class="tsd-signature-type">ESceneEntityType</a> = ESceneEntityType.PointLine3DSceneEntity
...
- get nativeEntity(): SCRTPointLine3DSceneEntity
...
- Gets the native [SCRTSceneEntity](https://www.scichart.com/documentation/js/v4/typedoc/enums/esceneentitytype.html#scrtsceneentity) - a WebAssembly 3D Scene Entity type which is passed to our WebGL WebAssembly 3D Engine
  ...
  #### Returns SCRTPointLine3DSceneEntity
...
- hitTest(screenPoint: <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/point.html" class="tsd-signature-type">Point</a>): <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/hittestinfo3d.html" class="tsd-signature-type">HitTestInfo3D</a>

<!-- -->

- Performs a HitTest operation on the entity, returning the [HitTestInfo3D](https://www.scichart.com/documentation/js/v4/typedoc/classes/hittestinfo3d.html) containing the result. This contains information about the hit-test operation such as the index of the data-point under the mouse, and may be used for tooltips, selection or inspection of the 3d scene through mouse-clicks
...
- hitTestXyz(screenPoint: <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/point.html" class="tsd-signature-type">Point</a>): <a href="https://www.scichart.com/documentation/js/v4/typedoc/classes/hittestinfo3d.html" class="tsd-signature-type">HitTestInfo3D</a>
...
- setNativeEntity(entity: SCRTPointLine3DSceneEntity): void
...
- Called internally - sets the native entity
  ...
  - ##### entity: SCRTPointLine3DSceneEntity
