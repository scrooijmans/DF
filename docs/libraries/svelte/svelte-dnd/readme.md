# GitHub - thisuxhq/sveltednd: A lightweight, flexible drag and drop library for Svelte 5 applications.
...
<script lang="ts">
	...
	const dragStyles = {
		low: 'bg-linear-to-r from-sky-400/30 via-blue-400/20 to-indigo-400/30 backdrop-blur-lg',
		medium:
			'bg-linear-to-r from-amber-400/30 via-orange-400/20 to-yellow-400/30 backdrop-blur-lg',
		high: 'bg-linear-to-r from-rose-400/30 via-red-400/20 to-pink-400/30 backdrop-blur-lg'
	};
</script>

<div class="min-h-screen bg-linear-to-br from-slate-50 to-gray-100 p-8">
				...
				{#each items as item, index (item.id)}
					...
					>
						<div class="relative overflow-hidden rounded-md">
							...
							<div
								class="absolute inset-0 bg-linear-to-br from-white/10 via-transparent to-white/20 opacity-0
