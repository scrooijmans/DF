Description: Executes the `dot` command line executable using the given Graph, PrinterContext and command line arguments.

Title: exec in graphviz_rust - Rust
