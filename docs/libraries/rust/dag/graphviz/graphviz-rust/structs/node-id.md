# NodeId in dot_structures - Rust

[dot_structures](index.html)

## Struct NodeId 

[Source](about:blank/src/dot_structures/lib.rs.html#52)
...
[§](#structfield.0)`0: [Id](enum.Id.html "enum dot_structures::Id")`[§](#structfield.1)`1: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Port](struct.Port.html "struct dot_structures::Port")>`

## Trait Implementations[§](#trait-implementations)

[Source](about:blank/src/dot_structures/lib.rs.html#51)
[§](#impl-Clone-for-NodeId)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [NodeId](struct.NodeId.html "struct dot_structures::NodeId")

[Source](about:blank/src/dot_structures/lib.rs.html#51)
[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [NodeId](struct.NodeId.html "struct dot_structures::NodeId")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [NodeId](struct.NodeId.html "struct dot_structures::NodeId")
...
### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [NodeId](struct.NodeId.html "struct dot_structures::NodeId")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [NodeId](struct.NodeId.html "struct dot_structures::NodeId")

[Source](about:blank/src/dot_structures/lib.rs.html#51)
[§](#method.eq)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[NodeId](struct.NodeId.html "struct dot_structures::NodeId")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [NodeId](struct.NodeId.html "struct dot_structures::NodeId")

[Source](about:blank/src/dot_structures/lib.rs.html#51)
[§](#impl-StructuralPartialEq-for-NodeId)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [NodeId](struct.NodeId.html "struct dot_structures::NodeId")

## Auto Trait Implementations[§](#synthetic-implementations)

[§](#impl-Freeze-for-NodeId)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [NodeId](struct.NodeId.html "struct dot_structures::NodeId")

[§](#impl-RefUnwindSafe-for-NodeId)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [NodeId](struct.NodeId.html "struct dot_structures::NodeId")

[§](#impl-Send-for-NodeId)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [NodeId](struct.NodeId.html "struct dot_structures::NodeId")

[§](#impl-Sync-for-NodeId)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [NodeId](struct.NodeId.html "struct dot_structures::NodeId")

[§](#impl-Unpin-for-NodeId)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [NodeId](struct.NodeId.html "struct dot_structures::NodeId")

[§](#impl-UnwindSafe-for-NodeId)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [NodeId](struct.NodeId.html "struct dot_structures::NodeId")
