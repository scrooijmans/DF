# Attribute in dot_structures - Rust

[dot_structures](index.html)

## Struct Attribute 

[Source](about:blank/src/dot_structures/lib.rs.html#56)
...
[§](#structfield.0)`0: [Id](enum.Id.html "enum dot_structures::Id")`[§](#structfield.1)`1: [Id](enum.Id.html "enum dot_structures::Id")`

## Trait Implementations[§](#trait-implementations)

[Source](about:blank/src/dot_structures/lib.rs.html#55)
[§](#impl-Clone-for-Attribute)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Attribute](struct.Attribute.html "struct dot_structures::Attribute")

[Source](about:blank/src/dot_structures/lib.rs.html#55)
[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Attribute](struct.Attribute.html "struct dot_structures::Attribute")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Attribute](struct.Attribute.html "struct dot_structures::Attribute")
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Attribute](struct.Attribute.html "struct dot_structures::Attribute")\> for [Stmt](enum.Stmt.html "enum dot_structures::Stmt")

[Source](about:blank/src/dot_structures/lib.rs.html#140-142)
[§](#method.from)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(v: [Attribute](struct.Attribute.html "struct dot_structures::Attribute")) -> Self
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Attribute](struct.Attribute.html "struct dot_structures::Attribute")

[Source](about:blank/src/dot_structures/lib.rs.html#55)
[§](#method.eq)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Attribute](struct.Attribute.html "struct dot_structures::Attribute")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Attribute](struct.Attribute.html "struct dot_structures::Attribute")

## Auto Trait Implementations[§](#synthetic-implementations)

[§](#impl-Freeze-for-Attribute)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Attribute](struct.Attribute.html "struct dot_structures::Attribute")

[§](#impl-RefUnwindSafe-for-Attribute)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Attribute](struct.Attribute.html "struct dot_structures::Attribute")

[§](#impl-Send-for-Attribute)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Attribute](struct.Attribute.html "struct dot_structures::Attribute")

[§](#impl-Sync-for-Attribute)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Attribute](struct.Attribute.html "struct dot_structures::Attribute")

[§](#impl-Unpin-for-Attribute)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Attribute](struct.Attribute.html "struct dot_structures::Attribute")

[§](#impl-UnwindSafe-for-Attribute)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Attribute](struct.Attribute.html "struct dot_structures::Attribute")
