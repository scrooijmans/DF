# Edge in dot_structures - Rust

[dot_structures](index.html)

## Struct Edge 

[Source](about:blank/src/dot_structures/lib.rs.html#79-82)
...
[§](#structfield.ty)`ty: [EdgeTy](enum.EdgeTy.html "enum dot_structures::EdgeTy")`[§](#structfield.attributes)`attributes: [Vec](https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html "struct alloc::vec::Vec")<[Attribute](struct.Attribute.html "struct dot_structures::Attribute")>`

## Trait Implementations[§](#trait-implementations)

[Source](about:blank/src/dot_structures/lib.rs.html#78)
[§](#impl-Clone-for-Edge)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Edge](struct.Edge.html "struct dot_structures::Edge")

[Source](about:blank/src/dot_structures/lib.rs.html#78)
[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Edge](struct.Edge.html "struct dot_structures::Edge")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Edge](struct.Edge.html "struct dot_structures::Edge")
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Edge](struct.Edge.html "struct dot_structures::Edge")\> for [Stmt](enum.Stmt.html "enum dot_structures::Stmt")

[Source](about:blank/src/dot_structures/lib.rs.html#128-130)
[§](#method.from)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(v: [Edge](struct.Edge.html "struct dot_structures::Edge")) -> Self
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Edge](struct.Edge.html "struct dot_structures::Edge")

[Source](about:blank/src/dot_structures/lib.rs.html#78)
[§](#method.eq)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Edge](struct.Edge.html "struct dot_structures::Edge")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Edge](struct.Edge.html "struct dot_structures::Edge")

## Auto Trait Implementations[§](#synthetic-implementations)

[§](#impl-Freeze-for-Edge)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Edge](struct.Edge.html "struct dot_structures::Edge")

[§](#impl-RefUnwindSafe-for-Edge)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Edge](struct.Edge.html "struct dot_structures::Edge")

[§](#impl-Send-for-Edge)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Edge](struct.Edge.html "struct dot_structures::Edge")

[§](#impl-Sync-for-Edge)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Edge](struct.Edge.html "struct dot_structures::Edge")

[§](#impl-Unpin-for-Edge)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Edge](struct.Edge.html "struct dot_structures::Edge")

[§](#impl-UnwindSafe-for-Edge)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Edge](struct.Edge.html "struct dot_structures::Edge")
