# EdgeTy in dot_structures - Rust

[dot_structures](index.html)

## Enum EdgeTy 

[Source](about:blank/src/dot_structures/lib.rs.html#93-96)
...
### Pair([Vertex](enum.Vertex.html "enum dot_structures::Vertex"), [Vertex](enum.Vertex.html "enum dot_structures::Vertex"))

[§](#variant.Chain)

### Chain([Vec](https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html "struct alloc::vec::Vec")<[Vertex](enum.Vertex.html "enum dot_structures::Vertex")\>)

## Trait Implementations[§](#trait-implementations)

[Source](about:blank/src/dot_structures/lib.rs.html#92)
[§](#impl-Clone-for-EdgeTy)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [EdgeTy](enum.EdgeTy.html "enum dot_structures::EdgeTy")

[Source](about:blank/src/dot_structures/lib.rs.html#92)
[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [EdgeTy](enum.EdgeTy.html "enum dot_structures::EdgeTy")
...
[Source](about:blank/src/dot_structures/lib.rs.html#92)
[§](#impl-Debug-for-EdgeTy)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [EdgeTy](enum.EdgeTy.html "enum dot_structures::EdgeTy")
...
[Source](about:blank/src/dot_structures/lib.rs.html#92)
[§](#impl-PartialEq-for-EdgeTy)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [EdgeTy](enum.EdgeTy.html "enum dot_structures::EdgeTy")

[Source](about:blank/src/dot_structures/lib.rs.html#92)
[§](#method.eq)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[EdgeTy](enum.EdgeTy.html "enum dot_structures::EdgeTy")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [EdgeTy](enum.EdgeTy.html "enum dot_structures::EdgeTy")

## Auto Trait Implementations[§](#synthetic-implementations)

[§](#impl-Freeze-for-EdgeTy)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [EdgeTy](enum.EdgeTy.html "enum dot_structures::EdgeTy")

[§](#impl-RefUnwindSafe-for-EdgeTy)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [EdgeTy](enum.EdgeTy.html "enum dot_structures::EdgeTy")

[§](#impl-Send-for-EdgeTy)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [EdgeTy](enum.EdgeTy.html "enum dot_structures::EdgeTy")

[§](#impl-Sync-for-EdgeTy)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [EdgeTy](enum.EdgeTy.html "enum dot_structures::EdgeTy")

[§](#impl-Unpin-for-EdgeTy)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [EdgeTy](enum.EdgeTy.html "enum dot_structures::EdgeTy")

[§](#impl-UnwindSafe-for-EdgeTy)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [EdgeTy](enum.EdgeTy.html "enum dot_structures::EdgeTy")
