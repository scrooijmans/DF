...
## Required Methods<a href="https://docs.rs/polars/latest/polars/datatypes/trait.GetAnyValue.html#required-methods" class="anchor">§</a>

#### unsafe fn <a href="https://docs.rs/polars/latest/polars/datatypes/trait.GetAnyValue.html#tymethod.get_unchecked" class="fn">get_unchecked</a>(&self, index: <a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>) -\> <a href="https://docs.rs/polars/latest/polars/prelude/enum.AnyValue.html" class="enum" title="enum polars::prelude::AnyValue">AnyValue</a>\<'\_\>

##### <a href="https://docs.rs/polars/latest/polars/datatypes/trait.GetAnyValue.html#safety" class="doc-anchor">§</a>Safety

Get an value without doing bound checks.

## Implementations on Foreign Types<a href="https://docs.rs/polars/latest/polars/datatypes/trait.GetAnyValue.html#foreign-impls" class="anchor">§</a>

<a href="https://docs.rs/polars/latest/polars/datatypes/trait.GetAnyValue.html#impl-GetAnyValue-for-Box%3Cdyn+Array%3E" class="anchor">§</a>
...
<a href="https://docs.rs/polars/latest/polars/datatypes/trait.GetAnyValue.html#method.get_unchecked" class="anchor">§</a>

#### unsafe fn <a href="https://docs.rs/polars/latest/polars/datatypes/trait.GetAnyValue.html#tymethod.get_unchecked" class="fn">get_unchecked</a>(&self, index: <a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>) -\> <a href="https://docs.rs/polars/latest/polars/prelude/enum.AnyValue.html" class="enum" title="enum polars::prelude::AnyValue">AnyValue</a>\<'\_\>

## Implementors<a href="https://docs.rs/polars/latest/polars/datatypes/trait.GetAnyValue.html#implementors" class="anchor">§</a>
