...
[§](#ballista-distributed-scheduler-for-apache-datafusion)Ballista: Distributed Scheduler for Apache DataFusion
---------------------------------------------------------------------------------------------------------------
...
For full documentation, refer to the deployment section of the [Ballista User Guide](https://datafusion.apache.org/ballista/user-guide/deployment/)
...
#### [§](#overall-speedup)Overall Speedup
...
#### [§](#absolute-speedup)Absolute Speedup
...
`pub use [datafusion](https://docs.rs/datafusion/49.0.2/x86_64-unknown-linux-gnu/datafusion/index.html "mod datafusion");`

[extension](extension/index.html "mod ballista::extension")

[prelude](prelude/index.html "mod ballista::prelude")
