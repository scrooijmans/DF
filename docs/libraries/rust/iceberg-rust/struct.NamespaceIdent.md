# Struct NamespaceIdent Copy item path

<a href="https://docs.rs/iceberg/0.7.0/src/iceberg/catalog/mod.rs.html#131" class="src">Source</a>

``` rust
pub struct NamespaceIdent(/* private fields */);
```
...
The namespace identifier is a list of strings, where each string is a component of the namespace. It’s the catalog implementer’s responsibility to handle the namespace identifier correctly.

## Implementations<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#implementations" class="anchor">§</a>

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#impl-NamespaceIdent" class="anchor">§</a>

### impl <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html" class="struct" title="struct iceberg::NamespaceIdent">NamespaceIdent</a>

#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.new" class="fn">new</a>(name: <a href="https://doc.rust-lang.org/nightly/alloc/string/struct.String.html" class="struct" title="struct alloc::string::String">String</a>) -\> Self

Create a new namespace identifier with only one level.

#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.from_vec" class="fn">from_vec</a>(names: <a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<<a href="https://doc.rust-lang.org/nightly/alloc/string/struct.String.html" class="struct" title="struct alloc::string::String">String</a>\>) -\> <a href="https://docs.rs/iceberg/0.7.0/iceberg/type.Result.html" class="type" title="type iceberg::Result">Result</a>\<Self\>

Create a multi-level namespace identifier from vector.

#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.from_strs" class="fn">from_strs</a>(iter: impl <a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html" class="trait" title="trait core::iter::traits::collect::IntoIterator">IntoIterator</a>\<Item = impl <a href="https://doc.rust-lang.org/nightly/alloc/string/trait.ToString.html" class="trait" title="trait alloc::string::ToString">ToString</a>\>) -\> <a href="https://docs.rs/iceberg/0.7.0/iceberg/type.Result.html" class="type" title="type iceberg::Result">Result</a>\<Self\>

Try to create namespace identifier from an iterator of string.

#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.to_url_string" class="fn">to_url_string</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/alloc/string/struct.String.html" class="struct" title="struct alloc::string::String">String</a>

Returns a string for used in url.

#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.inner" class="fn">inner</a>(self) -\> <a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<<a href="https://doc.rust-lang.org/nightly/alloc/string/struct.String.html" class="struct" title="struct alloc::string::String">String</a>\>

Returns inner strings.

#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.parent" class="fn">parent</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/core/option/enum.Option.html" class="enum" title="enum core::option::Option">Option</a>\<Self\>

Get the parent of this namespace. Returns None if this namespace only has a single element and thus has no parent.

## Methods from <a href="https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html" class="trait" title="trait core::ops::deref::Deref">Deref</a>\<Target = \[<a href="https://doc.rust-lang.org/nightly/alloc/string/struct.String.html" class="struct" title="struct alloc::string::String">String</a>\]\><a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#deref-methods-%5BString%5D" class="anchor">§</a>

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/slice/mod.rs.html#114" class="src">Source</a>

#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.len" class="fn">len</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>

Returns the number of elements in the slice.

##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.is_empty" class="fn">is_empty</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Returns `true` if the slice has a length of 0.

##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-1" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-2" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-3" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-4" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-5" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-6" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-7" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-8" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-9" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-10" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#safety" class="doc-anchor">§</a>Safety
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-11" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.as_ptr" class="fn">as_ptr</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.pointer.html" class="primitive">*const T</a>
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-12" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.iter" class="fn">iter</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.Iter.html" class="struct" title="struct core::slice::iter::Iter">Iter</a>\<'\_, T\>

Returns an iterator over the slice.

The iterator yields all items from start to end.

##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-13" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#panics" class="doc-anchor">§</a>Panics

Panics if `size` is zero.

##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-14" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#panics-1" class="doc-anchor">§</a>Panics

Panics if `chunk_size` is zero.

##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-15" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#panics-2" class="doc-anchor">§</a>Panics

Panics if `chunk_size` is zero.

##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-16" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#safety-1" class="doc-anchor">§</a>Safety
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-17" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#panics-3" class="doc-anchor">§</a>Panics
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-18" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#panics-4" class="doc-anchor">§</a>Panics

Panics if `N` is zero.

Note that this check is against a const generic parameter, not a runtime value, and thus a particular monomorphization will either always panic or it will never panic.

##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-19" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#panics-5" class="doc-anchor">§</a>Panics

Panics if `N` is zero. This check will most probably get changed to a compile time error before this method gets stabilized.

##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-20" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#panics-6" class="doc-anchor">§</a>Panics

Panics if `chunk_size` is zero.

##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-21" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#panics-7" class="doc-anchor">§</a>Panics

Panics if `chunk_size` is zero.

##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-22" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.chunk_by" class="fn">chunk_by</a>\<F\>(&self, pred: F) -\> <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.ChunkBy.html" class="struct" title="struct core::slice::iter::ChunkBy">ChunkBy</a>\<'\_, T, F\>
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-23" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#panics-8" class="doc-anchor">§</a>Panics
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-24" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#safety-2" class="doc-anchor">§</a>Safety
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-25" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-26" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.split" class="fn">split</a>\<F\>(&self, pred: F) -\> <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.Split.html" class="struct" title="struct core::slice::iter::Split">Split</a>\<'\_, T, F\>
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-27" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-28" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.rsplit" class="fn">rsplit</a>\<F\>(&self, pred: F) -\> <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.RSplit.html" class="struct" title="struct core::slice::iter::RSplit">RSplit</a>\<'\_, T, F\>

where F: <a href="https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html" class="trait" title="trait core::ops::function::FnMut">FnMut</a>(<a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;T</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>,

Returns an iterator over subslices separated by elements that match `pred`, starting at the end of the slice and working backwards. The matched element is not contained in the subslices.

##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-29" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-30" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-31" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-32" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-33" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.contains" class="fn">contains</a>(&self, x: <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;T</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-34" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.starts_with" class="fn">starts_with</a>(&self, needle: &<a href="https://doc.rust-lang.org/nightly/std/primitive.slice.html" class="primitive">[T]</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

where T: <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html" class="trait" title="trait core::cmp::PartialEq">PartialEq</a>,

Returns `true` if `needle` is a prefix of the slice or equal to the slice.

##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-35" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.ends_with" class="fn">ends_with</a>(&self, needle: &<a href="https://doc.rust-lang.org/nightly/std/primitive.slice.html" class="primitive">[T]</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

where T: <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html" class="trait" title="trait core::cmp::PartialEq">PartialEq</a>,

Returns `true` if `needle` is a suffix of the slice or equal to the slice.

##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-36" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-37" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-38" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-39" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-40" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-41" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-42" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-43" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#safety-3" class="doc-anchor">§</a>Safety

This method is essentially a `transmute` with respect to the elements in the returned middle slice, so all the usual caveats pertaining to `transmute::<T, U>` also apply here.

##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-44" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#panics-9" class="doc-anchor">§</a>Panics

This will panic if the size of the SIMD type is different from `LANES` times that of the scalar.

At the time of writing, the trait restrictions on `Simd<T, LANES>` keeps that from ever happening, as only power-of-two numbers of lanes are supported. It’s possible that, in the future, those restrictions might be lifted in a way that would make it possible to see panics from this method for something like `LANES == 3`.

##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-45" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.is_sorted" class="fn">is_sorted</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-46" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.is_sorted_by" class="fn">is_sorted_by</a>\<'a, F\>(&'a self, compare: F) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-47" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.is_sorted_by_key" class="fn">is_sorted_by_key</a>\<'a, F, K\>(&'a self, f: F) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-48" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.partition_point" class="fn">partition_point</a>\<P\>(&self, pred: P) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-49" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#panics-10" class="doc-anchor">§</a>Panics

Panics if `T` is zero-sized.

##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-50" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#panics-11" class="doc-anchor">§</a>Panics

Panics if `T` is zero-sized.

##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-51" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.to_vec" class="fn">to_vec</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<T\>
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-52" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.to_vec_in" class="fn">to_vec_in</a>\<A\>(&self, alloc: A) -\> <a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<T, A\>
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-53" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#panics-12" class="doc-anchor">§</a>Panics

This function will panic if the capacity would overflow.

##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-54" class="doc-anchor">§</a>Examples
...
<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#" class="tooltip" title="This example panics">ⓘ</a>
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-55" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-56" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#examples-57" class="doc-anchor">§</a>Examples
...
## Trait Implementations<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#trait-implementations" class="anchor">§</a>

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#impl-AsRef%3CVec%3CString%3E%3E-for-NamespaceIdent" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/convert/trait.AsRef.html" class="trait" title="trait core::convert::AsRef">AsRef</a>\<<a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<<a href="https://doc.rust-lang.org/nightly/alloc/string/struct.String.html" class="struct" title="struct alloc::string::String">String</a>\>\> for <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html" class="struct" title="struct iceberg::NamespaceIdent">NamespaceIdent</a>

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.as_ref" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/convert/trait.AsRef.html#tymethod.as_ref" class="fn">as_ref</a>(&self) -\> &<a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<<a href="https://doc.rust-lang.org/nightly/alloc/string/struct.String.html" class="struct" title="struct alloc::string::String">String</a>\>

Converts this type into a shared reference of the (usually inferred) input type.

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#impl-Clone-for-NamespaceIdent" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html" class="trait" title="trait core::clone::Clone">Clone</a> for <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html" class="struct" title="struct iceberg::NamespaceIdent">NamespaceIdent</a>

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.clone" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone" class="fn">clone</a>(&self) -\> <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html" class="struct" title="struct iceberg::NamespaceIdent">NamespaceIdent</a>

Returns a duplicate of the value. [Read more](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/clone.rs.html#245-247" class="src">Source</a><a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.clone_from" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#method.clone_from" class="fn">clone_from</a>(&mut self, source: &Self)

Performs copy-assignment from `source`. [Read more](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#method.clone_from)

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#impl-Debug-for-NamespaceIdent" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html" class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html" class="struct" title="struct iceberg::NamespaceIdent">NamespaceIdent</a>

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.fmt" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt" class="fn">fmt</a>(&self, f: &mut <a href="https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html" class="struct" title="struct core::fmt::Formatter">Formatter</a>\<'\_\>) -\> <a href="https://doc.rust-lang.org/nightly/core/fmt/type.Result.html" class="type" title="type core::fmt::Result">Result</a>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#impl-Deref-for-NamespaceIdent" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html" class="trait" title="trait core::ops::deref::Deref">Deref</a> for <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html" class="struct" title="struct iceberg::NamespaceIdent">NamespaceIdent</a>

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#associatedtype.Target" class="anchor">§</a>

#### type <a href="https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target" class="associatedtype">Target</a> = \[<a href="https://doc.rust-lang.org/nightly/alloc/string/struct.String.html" class="struct" title="struct alloc::string::String">String</a>\]

The resulting type after dereferencing.

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.deref" class="anchor">§</a>
...
<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#impl-Deserialize%3C&#39;de%3E-for-NamespaceIdent" class="anchor">§</a>

### impl\<'de\> <a href="https://docs.rs/serde/1.0.219/x86_64-unknown-linux-gnu/serde/de/trait.Deserialize.html" class="trait" title="trait serde::de::Deserialize">Deserialize</a>\<'de\> for <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html" class="struct" title="struct iceberg::NamespaceIdent">NamespaceIdent</a>

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.deserialize" class="anchor">§</a>
...
<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#impl-Display-for-NamespaceIdent" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html" class="trait" title="trait core::fmt::Display">Display</a> for <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html" class="struct" title="struct iceberg::NamespaceIdent">NamespaceIdent</a>

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.fmt-1" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html#tymethod.fmt" class="fn">fmt</a>(&self, f: &mut <a href="https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html" class="struct" title="struct core::fmt::Formatter">Formatter</a>\<'\_\>) -\> <a href="https://doc.rust-lang.org/nightly/core/fmt/type.Result.html" class="type" title="type core::fmt::Result">Result</a>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html#tymethod.fmt)

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#impl-Hash-for-NamespaceIdent" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html" class="trait" title="trait core::hash::Hash">Hash</a> for <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html" class="struct" title="struct iceberg::NamespaceIdent">NamespaceIdent</a>

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.hash" class="anchor">§</a>
...
1.3.0 · <a href="https://doc.rust-lang.org/nightly/src/core/hash/mod.rs.html#235-237" class="src">Source</a><a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.hash_slice" class="anchor">§</a>
...
<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#impl-Ord-for-NamespaceIdent" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html" class="trait" title="trait core::cmp::Ord">Ord</a> for <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html" class="struct" title="struct iceberg::NamespaceIdent">NamespaceIdent</a>

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.cmp" class="anchor">§</a>
...
1.21.0 · <a href="https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#1021-1023" class="src">Source</a><a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.max" class="anchor">§</a>
...
1.21.0 · <a href="https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#1060-1062" class="src">Source</a><a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.min" class="anchor">§</a>
...
1.50.0 · <a href="https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#1086-1088" class="src">Source</a><a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.clamp" class="anchor">§</a>
...
<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#impl-PartialEq-for-NamespaceIdent" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html" class="trait" title="trait core::cmp::PartialEq">PartialEq</a> for <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html" class="struct" title="struct iceberg::NamespaceIdent">NamespaceIdent</a>

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.eq" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#264" class="src">Source</a><a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.ne" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#method.ne" class="fn">ne</a>(&self, other: <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;Rhs</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Tests for `!=`. The default implementation is almost always sufficient, and should not be overridden without very good reason.

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#impl-PartialOrd-for-NamespaceIdent" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html" class="trait" title="trait core::cmp::PartialOrd">PartialOrd</a> for <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html" class="struct" title="struct iceberg::NamespaceIdent">NamespaceIdent</a>

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.partial_cmp" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#1398" class="src">Source</a><a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.lt" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#method.lt" class="fn">lt</a>(&self, other: <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;Rhs</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Tests less than (for `self` and `other`) and is used by the `<` operator. [Read more](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#method.lt)

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#1416" class="src">Source</a><a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.le" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#method.le" class="fn">le</a>(&self, other: <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;Rhs</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Tests less than or equal to (for `self` and `other`) and is used by the `<=` operator. [Read more](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#method.le)

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#1434" class="src">Source</a><a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.gt" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#method.gt" class="fn">gt</a>(&self, other: <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;Rhs</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Tests greater than (for `self` and `other`) and is used by the `>` operator. [Read more](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#method.gt)

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#1452" class="src">Source</a><a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.ge" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#method.ge" class="fn">ge</a>(&self, other: <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;Rhs</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Tests greater than or equal to (for `self` and `other`) and is used by the `>=` operator. [Read more](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#method.ge)

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#impl-Serialize-for-NamespaceIdent" class="anchor">§</a>

### impl <a href="https://docs.rs/serde/1.0.219/x86_64-unknown-linux-gnu/serde/ser/trait.Serialize.html" class="trait" title="trait serde::ser::Serialize">Serialize</a> for <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html" class="struct" title="struct iceberg::NamespaceIdent">NamespaceIdent</a>

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#method.serialize" class="anchor">§</a>
...
<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#impl-Eq-for-NamespaceIdent" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html" class="trait" title="trait core::cmp::Eq">Eq</a> for <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html" class="struct" title="struct iceberg::NamespaceIdent">NamespaceIdent</a>

<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#impl-StructuralPartialEq-for-NamespaceIdent" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html" class="trait" title="trait core::marker::StructuralPartialEq">StructuralPartialEq</a> for <a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html" class="struct" title="struct iceberg::NamespaceIdent">NamespaceIdent</a>

## Auto Trait Implementations<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#synthetic-implementations" class="anchor">§</a>

## Blanket Implementations<a href="https://docs.rs/iceberg/0.7.0/iceberg/struct.NamespaceIdent.html#blanket-implementations" class="anchor">§</a>
