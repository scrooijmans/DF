...
- <a href="https://docs.rs/crate/opendal/latest/builds#" class="pure-menu-link" aria-label="docs.rs">docs.rs</a>
...
- <a href="https://docs.rs/crate/opendal/latest/builds#" class="pure-menu-link" aria-label="Rust">Rust</a>
...
- <a href="https://docs.rs/crate/opendal/latest/builds" class="pure-menu-link pure-menu-active">  Builds</a>
- <a href="https://docs.rs/crate/opendal/latest/features" class="pure-menu-link"> Feature flags</a>

**Builds**

<a href="https://docs.rs/crate/opendal/0.54.1/builds/2582519" class="release"></a>

rustc 1.92.0-nightly (2300c2aef 2025-10-12)

docsrs 0.6.0 (f42173de 2025-09-12)

Oct 13, 2025

#### opendal's sandbox limits
...
If a build fails because it hit one of those limits please [open an issue](https://github.com/rust-lang/docs.rs/issues/new/choose) to get them increased.
