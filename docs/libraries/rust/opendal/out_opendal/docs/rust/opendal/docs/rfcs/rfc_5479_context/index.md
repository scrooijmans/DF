# Module rfc_5479_context Copy item path

<a href="https://opendal.apache.org/docs/rust/src/opendal/docs/rfcs/mod.rs.html#250" class="src">Source</a>
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_5479_context/index.html#summary" class="doc-anchor">Â§</a>Summary

Add `Context` in opendal to distribute global resources like http client, runtime, etc.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_5479_context/index.html#motivation" class="doc-anchor">Â§</a>Motivation
...
However, itâ€™s a bit challenging for layers to interact with these global resources.

### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_5479_context/index.html#for-http-client" class="doc-anchor">Â§</a>For http client
...
### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_5479_context/index.html#for-runtime" class="doc-anchor">Â§</a>For runtime
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_5479_context/index.html#guide-level-explanation" class="doc-anchor">Â§</a>Guide-level explanation
...
- `OpWrite::executor`
- All services buildersâ€™ `http_client` API

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_5479_context/index.html#reference-level-explanation" class="doc-anchor">Â§</a>Reference-level explanation
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_5479_context/index.html#drawbacks" class="doc-anchor">Â§</a>Drawbacks

A bit cost (`50ns`) for every operation that `load_http_client`.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_5479_context/index.html#rationale-and-alternatives" class="doc-anchor">Â§</a>Rationale and alternatives

None.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_5479_context/index.html#prior-art" class="doc-anchor">Â§</a>Prior art

None.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_5479_context/index.html#unresolved-questions" class="doc-anchor">Â§</a>Unresolved questions

None.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_5479_context/index.html#future-possibilities" class="doc-anchor">Â§</a>Future possibilities
