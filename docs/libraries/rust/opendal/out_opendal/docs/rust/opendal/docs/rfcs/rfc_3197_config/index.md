# Module rfc_3197_config Copy item path

<a href="https://opendal.apache.org/docs/rust/src/opendal/docs/rfcs/mod.rs.html#198" class="src">Source</a>
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_3197_config/index.html#summary" class="doc-anchor">Â§</a>Summary

Expose services config to the user.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_3197_config/index.html#motivation" class="doc-anchor">Â§</a>Motivation
...
This is one of our limitations: We need a way to configure services that is type safe, easy to use and flexible. The other one is that there is no way for users to fetch the config of a service after itâ€™s built. This limitation complicates the dynamic modification of a serviceâ€™s root path for the user.
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_3197_config/index.html#guide-level-explanation" class="doc-anchor">Â§</a>Guide-level explanation
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_3197_config/index.html#reference-level-explanation" class="doc-anchor">Â§</a>Reference-level explanation
...
The public API of existing builders will remain unchanged, although their internal implementations will be modified to utilize `XxxConfig`. Type that canâ€™t be represents as `String` like `Box<dyn AwsCredentialLoad>` and `HttpClient` will be kept in `Builder` as before.
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_3197_config/index.html#drawbacks" class="doc-anchor">Â§</a>Drawbacks

### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_3197_config/index.html#api-surface" class="doc-anchor">Â§</a>API Surface

This modification will significantly expand OpenDALâ€™s public API surface, makes it harder to maintain and increases the risk of breaking changes. Also, this change will add much more work for bindings which need to implement `XxxConfig` for each service.

### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_3197_config/index.html#secrets-leakage" class="doc-anchor">Â§</a>Secrets Leakage

After our config supports `Serialize`, itâ€™s possible that users will serialize the config and log it. This will lead to secrets leakage. We should add a warning in the docs to prevent this. And we should also encourage uses of services like AWS IAM instead of static secrets.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_3197_config/index.html#rationale-and-alternatives" class="doc-anchor">Â§</a>Rationale and alternatives

### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_3197_config/index.html#move-root-out-of-service-config-to-operator-level" class="doc-anchor">Â§</a>Move `root` out of service config to operator level
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_3197_config/index.html#prior-art" class="doc-anchor">Â§</a>Prior art

None.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_3197_config/index.html#unresolved-questions" class="doc-anchor">Â§</a>Unresolved questions

None.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_3197_config/index.html#future-possibilities" class="doc-anchor">Â§</a>Future possibilities

### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_3197_config/index.html#implement-fromstr-for-config" class="doc-anchor">Â§</a>Implement `FromStr` for `Config`
...
### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_3197_config/index.html#implement-serialize-for-config" class="doc-anchor">Â§</a>Implement `Serialize` for `Config`
...
### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_3197_config/index.html#implement-check-for-config" class="doc-anchor">Â§</a>Implement `check` for `Config`
