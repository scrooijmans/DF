# Module rfc_0623_redis_service Copy item path

<a href="https://opendal.apache.org/docs/rust/src/opendal/docs/rfcs/mod.rs.html#114" class="src">Source</a>
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0623_redis_service/index.html#summary" class="doc-anchor">Â§</a>Summary

Use [redis](https://redis.io) as a service of OpenDAL.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0623_redis_service/index.html#motivation" class="doc-anchor">Â§</a>Motivation

Redis is a fast, in-memory cache with persistent and distributed storage functionalities. Itâ€™s widely used in production.

Users also demand more backend support. Redis is a good candidate.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0623_redis_service/index.html#guide-level-explanation" class="doc-anchor">Â§</a>Guide-level explanation
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0623_redis_service/index.html#reference-level-explanation" class="doc-anchor">Â§</a>Reference-level explanation
...
The [redis-rs](https://crates.io/crates/redis)â€™s high level APIs is preferred.
...
### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0623_redis_service/index.html#forward-compatibility" class="doc-anchor">Â§</a>Forward Compatibility

All keys used will have a `v0` prefix, indicating itâ€™s using the very first version of `OpenDAL` `Redis` API.
...
### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0623_redis_service/index.html#create-file" class="doc-anchor">Â§</a>Create File
...
### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0623_redis_service/index.html#read-file" class="doc-anchor">Â§</a>Read File
...
### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0623_redis_service/index.html#write-file" class="doc-anchor">Â§</a>Write File
...
### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0623_redis_service/index.html#stat" class="doc-anchor">Â§</a>Stat
...
### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0623_redis_service/index.html#list" class="doc-anchor">Â§</a>List
...
### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0623_redis_service/index.html#delete" class="doc-anchor">Â§</a>Delete

All subdirectories of path will be listed and removed.

On deleting a file or directory, the backend should remove the entry from its parentâ€™s `SET`, and remove all children of entry.
...
### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0623_redis_service/index.html#blocking-apis" class="doc-anchor">Â§</a>Blocking APIs

`redis-rs` also offers a synchronous version of API, just port the functions above to its synchronous version.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0623_redis_service/index.html#drawbacks" class="doc-anchor">Â§</a>Drawbacks
...
3.  Grouping atomic operations together doesnâ€™t promise transactional access, this may lead to data racing issues.
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0623_redis_service/index.html#rationale-and-alternatives" class="doc-anchor">Â§</a>Rationale and alternatives

### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0623_redis_service/index.html#redisjson-module" class="doc-anchor">Â§</a>RedisJSON module
...
Since `bincode` also offers the ability of deserializing and serializing, `RedisJSON` wonâ€™t be used.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0623_redis_service/index.html#prior-art" class="doc-anchor">Â§</a>Prior art

None

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0623_redis_service/index.html#unresolved-questions" class="doc-anchor">Â§</a>Unresolved questions

None

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0623_redis_service/index.html#future-possibilities" class="doc-anchor">Â§</a>Future possibilities
