# Module rfc_0057_auto_region Copy item path

<a href="https://opendal.apache.org/docs/rust/src/opendal/docs/rfcs/mod.rs.html#34" class="src">Source</a>
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0057_auto_region/index.html#summary" class="doc-anchor">Â§</a>Summary

Automatically detecting userâ€™s s3 region.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0057_auto_region/index.html#motivation" class="doc-anchor">Â§</a>Motivation

Current behavior for `region` and `endpoint` is buggy. `endpoint=https://s3.amazonaws.com` and `endpoint=""` are expected to be the same, because `endpoint=""` means take the default value `https://s3.amazonaws.com`. However, they arenâ€™t.
...
Automatically detecting the userâ€™s s3 region will help resolve this problem. Users donâ€™t need to care about the region anymore, `OpenDAL` will figure it out. Everything works regardless of whether the input is `s3.amazonaws.com` or `s3.us-east-1.amazonaws.com`.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0057_auto_region/index.html#guide-level-explanation" class="doc-anchor">Â§</a>Guide-level explanation
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0057_auto_region/index.html#reference-level-explanation" class="doc-anchor">Â§</a>Reference-level explanation
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0057_auto_region/index.html#drawbacks" class="doc-anchor">Â§</a>Drawbacks

None.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0057_auto_region/index.html#rationale-and-alternatives" class="doc-anchor">Â§</a>Rationale and alternatives

### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0057_auto_region/index.html#use-virtual-style-bucketendpoint" class="doc-anchor">Â§</a>Use virtual style `<bucket>.<endpoint>`?
...
### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0057_auto_region/index.html#use-listbuckets-api" class="doc-anchor">Â§</a>Use `ListBuckets` API?

`ListBuckets` requires higher permission than normal bucket read and write operations. Itâ€™s better to finish the job without requesting more permission.

### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0057_auto_region/index.html#misbehavior-s3-compilable-services" class="doc-anchor">Â§</a>Misbehavior S3 Compilable Services

Many services didnâ€™t implement S3 API correctly.
...
In this proposal, we will not figure them out. Itâ€™s easier for the user to fill the correct endpoint instead of automatically detecting them.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0057_auto_region/index.html#prior-art" class="doc-anchor">Â§</a>Prior art

None

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0057_auto_region/index.html#unresolved-questions" class="doc-anchor">Â§</a>Unresolved questions

None

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0057_auto_region/index.html#future-possibilities" class="doc-anchor">Â§</a>Future possibilities
