# Module rfc_4382_range_based_read Copy item path

<a href="https://opendal.apache.org/docs/rust/src/opendal/docs/rfcs/mod.rs.html#234" class="src">Source</a>
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_4382_range_based_read/index.html#summary" class="doc-anchor">Â§</a>Summary

Convert `oio::Read` into a stateless, range-based reading pattern.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_4382_range_based_read/index.html#motivation" class="doc-anchor">Â§</a>Motivation
...
- `Reader` canâ€™t adopt Completion-based IO

### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_4382_range_based_read/index.html#misuse-of-asyncseek" class="doc-anchor">Â§</a>Misuse of `AsyncSeek`
...
For example, `s3` storage does not support `seek` natively. When users call `seek`, opendal will drop current reader and sending a new request. This behavior is hidden from users and can lead to unexpected performance issues like [Whatâ€™s going on in my parquet stream](https://github.com/apache/opendal/issues/3725).

### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_4382_range_based_read/index.html#lack-of-concurrent-reading" class="doc-anchor">Â§</a>Lack of concurrent reading
...
### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_4382_range_based_read/index.html#cant-adopt-completion-based-io" class="doc-anchor">Â§</a>Canâ€™t adopt Completion-based IO

Completion-based IO requires take the bufferâ€™s owner ship. But API that take `&mut [u8]` canâ€™t do that.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_4382_range_based_read/index.html#guide-level-explanation" class="doc-anchor">Â§</a>Guide-level explanation
...
Apart from `Reader`â€™s own API, we will also provide convert to existing IO APIs like:
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_4382_range_based_read/index.html#reference-level-explanation" class="doc-anchor">Â§</a>Reference-level explanation
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_4382_range_based_read/index.html#drawbacks" class="doc-anchor">Â§</a>Drawbacks

### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_4382_range_based_read/index.html#breaking-changes-to-reader" class="doc-anchor">Â§</a>Breaking changes to `Reader`
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_4382_range_based_read/index.html#rationale-and-alternatives" class="doc-anchor">Â§</a>Rationale and alternatives

None.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_4382_range_based_read/index.html#prior-art" class="doc-anchor">Â§</a>Prior art

### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_4382_range_based_read/index.html#object_stores-api-design" class="doc-anchor">Â§</a>`object_store`â€™s API design

Current API design inspired from `object_store`â€™s `ObjectStore` a lot:
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_4382_range_based_read/index.html#unresolved-questions" class="doc-anchor">Â§</a>Unresolved questions

### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_4382_range_based_read/index.html#buffer" class="doc-anchor">Â§</a>Buffer
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_4382_range_based_read/index.html#future-possibilities" class="doc-anchor">Â§</a>Future possibilities

### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_4382_range_based_read/index.html#read-ranges" class="doc-anchor">Â§</a>Read Ranges
...
### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_4382_range_based_read/index.html#native-read_at-for-fs-and-hdfs" class="doc-anchor">Â§</a>Native `read_at` for fs and hdfs

We can reduce unnecessary `open` and `seek` syscalls by using the `read_at` API across different platforms.

### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_4382_range_based_read/index.html#auto-range-read" class="doc-anchor">Â§</a>Auto Range Read
...
### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_4382_range_based_read/index.html#completion-based-io" class="doc-anchor">Â§</a>Completion-based IO
