# Module rfc_1735_operation_extension Copy item path

<a href="https://opendal.apache.org/docs/rust/src/opendal/docs/rfcs/mod.rs.html#158" class="src">Source</a>
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_1735_operation_extension/index.html#summary" class="doc-anchor">Â§</a>Summary

Extend operation capabilities to support additional native features.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_1735_operation_extension/index.html#motivation" class="doc-anchor">Â§</a>Motivation
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_1735_operation_extension/index.html#guide-level-explanation" class="doc-anchor">Â§</a>Guide-level explanation
...
And, finally, we will support allow specify the default headers for services. Take `s3`â€™s `storage_class` as an example:
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_1735_operation_extension/index.html#reference-level-explanation" class="doc-anchor">Â§</a>Reference-level explanation
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_1735_operation_extension/index.html#drawbacks" class="doc-anchor">Â§</a>Drawbacks

None

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_1735_operation_extension/index.html#rationale-and-alternatives" class="doc-anchor">Â§</a>Rationale and alternatives

### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_1735_operation_extension/index.html#why-using-override_content_disposition-instead-of-response_content_disposition" class="doc-anchor">Â§</a>Why using `override_content_disposition` instead of `response_content_disposition`?

`response_content_disposition` is not a part of HTTP standard, itâ€™s the private API provided by `s3`.
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_1735_operation_extension/index.html#prior-art" class="doc-anchor">Â§</a>Prior art

None

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_1735_operation_extension/index.html#unresolved-questions" class="doc-anchor">Â§</a>Unresolved questions

None

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_1735_operation_extension/index.html#future-possibilities" class="doc-anchor">Â§</a>Future possibilities

### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_1735_operation_extension/index.html#strict-mode" class="doc-anchor">Â§</a>Strict Mode
