# Module rfc_0438_multipart Copy item path

<a href="https://opendal.apache.org/docs/rust/src/opendal/docs/rfcs/mod.rs.html#90" class="src">Source</a>
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0438_multipart/index.html#summary" class="doc-anchor">Â§</a>Summary

Add multipart support in OpenDAL.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0438_multipart/index.html#motivation" class="doc-anchor">Â§</a>Motivation
...
Before `CompleteMultipartUpload` has been called, users canâ€™t read already uploaded parts.
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0438_multipart/index.html#guide-level-explanation" class="doc-anchor">Â§</a>Guide-level explanation
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0438_multipart/index.html#reference-level-explanation" class="doc-anchor">Â§</a>Reference-level explanation
...
## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0438_multipart/index.html#drawbacks" class="doc-anchor">Â§</a>Drawbacks

None.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0438_multipart/index.html#rationale-and-alternatives" class="doc-anchor">Â§</a>Rationale and alternatives

### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0438_multipart/index.html#why-not-add-new-object-modes" class="doc-anchor">Â§</a>Why not add new object modes?
...
### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0438_multipart/index.html#why-not-split-object-into-file-and-dir" class="doc-anchor">Â§</a>Why not split Object into File and Dir?

We can split `Object` into `File` and `Dir` to avoid requiring `mode` in API. There is a vast API breakage too.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0438_multipart/index.html#prior-art" class="doc-anchor">Â§</a>Prior art

None.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0438_multipart/index.html#unresolved-questions" class="doc-anchor">Â§</a>Unresolved questions

None.

## <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0438_multipart/index.html#future-possibilities" class="doc-anchor">Â§</a>Future possibilities

### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0438_multipart/index.html#support-list-multipart-uploads" class="doc-anchor">Â§</a>Support list multipart uploads

We can support listing multipart uploads to list ongoing multipart uploads so we can resume an upload or abort them.

### <a href="https://opendal.apache.org/docs/rust/opendal/docs/rfcs/rfc_0438_multipart/index.html#support-list-part" class="doc-anchor">Â§</a>Support list part
