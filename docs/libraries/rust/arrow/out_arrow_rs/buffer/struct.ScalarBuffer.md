# Struct ScalarBuffer Copy item path

<a href="https://docs.rs/arrow-buffer/56.2.0/x86_64-unknown-linux-gnu/src/arrow_buffer/buffer/scalar.rs.html#45" class="src">Source</a>

``` rust
pub struct ScalarBuffer<T>where
    T: ArrowNativeType,{ /* private fields */ }
```

Expand description

A strongly-typed [`Buffer`](https://docs.rs/arrow/latest/arrow/buffer/struct.Buffer.html "struct arrow::buffer::Buffer") supporting zero-copy cloning and slicing

The easiest way to think about `ScalarBuffer<T>` is being equivalent to a `Arc<Vec<T>>`, with the following differences:
...
## Implementations<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#implementations" class="anchor">§</a>

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#impl-ScalarBuffer%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>
...
Unsafe function to create a new [`ScalarBuffer`](https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html "struct arrow::buffer::ScalarBuffer") from a [`Buffer`](https://docs.rs/arrow/latest/arrow/buffer/struct.Buffer.html "struct arrow::buffer::Buffer"). Only use for testing purpose.

##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#safety" class="doc-anchor">§</a>Safety

This function is unsafe because it does not check if the `buffer` is aligned

#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.shrink_to_fit" class="fn">shrink_to_fit</a>(&mut self)
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.inner" class="fn">inner</a>(&self) -\> &<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.Buffer.html" class="struct" title="struct arrow::buffer::Buffer">Buffer</a>

Returns the inner [`Buffer`](https://docs.rs/arrow/latest/arrow/buffer/struct.Buffer.html "struct arrow::buffer::Buffer")

#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.into_inner" class="fn">into_inner</a>(self) -\> <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.Buffer.html" class="struct" title="struct arrow::buffer::Buffer">Buffer</a>
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.ptr_eq" class="fn">ptr_eq</a>(&self, other: &<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Returns true if this [`ScalarBuffer`](https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html "struct arrow::buffer::ScalarBuffer") is equal to `other`, using pointer comparisons to determine buffer equality. This is cheaper than `PartialEq::eq` but may return false when the arrays are logically equal

#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.len" class="fn">len</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>

Returns the number of elements in the buffer

#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.is_empty" class="fn">is_empty</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Returns if the buffer is empty

## Methods from <a href="https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html" class="trait" title="trait core::ops::deref::Deref">Deref</a>\<Target = <a href="https://doc.rust-lang.org/nightly/std/primitive.slice.html" class="primitive">[T]</a>\><a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#deref-methods-%5BT%5D" class="anchor">§</a>

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/slice/mod.rs.html#114" class="src">Source</a>

#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.len-1" class="fn">len</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>

Returns the number of elements in the slice.

##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.is_empty-1" class="fn">is_empty</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Returns `true` if the slice has a length of 0.

##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-1" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-2" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-3" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-4" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-5" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-6" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-7" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-8" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-9" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-10" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#safety-1" class="doc-anchor">§</a>Safety
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-11" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.as_ptr" class="fn">as_ptr</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.pointer.html" class="primitive">*const T</a>
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-12" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.iter" class="fn">iter</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.Iter.html" class="struct" title="struct core::slice::iter::Iter">Iter</a>\<'\_, T\>

Returns an iterator over the slice.

The iterator yields all items from start to end.

##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-13" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#panics-1" class="doc-anchor">§</a>Panics

Panics if `size` is zero.

##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-14" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#panics-2" class="doc-anchor">§</a>Panics

Panics if `chunk_size` is zero.

##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-15" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#panics-3" class="doc-anchor">§</a>Panics

Panics if `chunk_size` is zero.

##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-16" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#safety-2" class="doc-anchor">§</a>Safety
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-17" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#panics-4" class="doc-anchor">§</a>Panics
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-18" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#panics-5" class="doc-anchor">§</a>Panics

Panics if `N` is zero.

Note that this check is against a const generic parameter, not a runtime value, and thus a particular monomorphization will either always panic or it will never panic.

##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-19" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#panics-6" class="doc-anchor">§</a>Panics

Panics if `N` is zero. This check will most probably get changed to a compile time error before this method gets stabilized.

##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-20" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#panics-7" class="doc-anchor">§</a>Panics

Panics if `chunk_size` is zero.

##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-21" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#panics-8" class="doc-anchor">§</a>Panics

Panics if `chunk_size` is zero.

##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-22" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.chunk_by" class="fn">chunk_by</a>\<F\>(&self, pred: F) -\> <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.ChunkBy.html" class="struct" title="struct core::slice::iter::ChunkBy">ChunkBy</a>\<'\_, T, F\>
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-23" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#panics-9" class="doc-anchor">§</a>Panics
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-24" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#safety-3" class="doc-anchor">§</a>Safety
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-25" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-26" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.split" class="fn">split</a>\<F\>(&self, pred: F) -\> <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.Split.html" class="struct" title="struct core::slice::iter::Split">Split</a>\<'\_, T, F\>
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-27" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-28" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.rsplit" class="fn">rsplit</a>\<F\>(&self, pred: F) -\> <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.RSplit.html" class="struct" title="struct core::slice::iter::RSplit">RSplit</a>\<'\_, T, F\>

where F: <a href="https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html" class="trait" title="trait core::ops::function::FnMut">FnMut</a>(<a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;T</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>,

Returns an iterator over subslices separated by elements that match `pred`, starting at the end of the slice and working backwards. The matched element is not contained in the subslices.

##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-29" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-30" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-31" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-32" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-33" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.contains" class="fn">contains</a>(&self, x: <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;T</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-34" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-35" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.ends_with" class="fn">ends_with</a>(&self, needle: &<a href="https://doc.rust-lang.org/nightly/std/primitive.slice.html" class="primitive">[T]</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

where T: <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html" class="trait" title="trait core::cmp::PartialEq">PartialEq</a>,

Returns `true` if `needle` is a suffix of the slice or equal to the slice.

##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-36" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-37" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-38" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-39" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-40" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-41" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-42" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-43" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#safety-4" class="doc-anchor">§</a>Safety

This method is essentially a `transmute` with respect to the elements in the returned middle slice, so all the usual caveats pertaining to `transmute::<T, U>` also apply here.

##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-44" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#panics-10" class="doc-anchor">§</a>Panics

This will panic if the size of the SIMD type is different from `LANES` times that of the scalar.

At the time of writing, the trait restrictions on `Simd<T, LANES>` keeps that from ever happening, as only power-of-two numbers of lanes are supported. It’s possible that, in the future, those restrictions might be lifted in a way that would make it possible to see panics from this method for something like `LANES == 3`.

##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-45" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.is_sorted" class="fn">is_sorted</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-46" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.is_sorted_by" class="fn">is_sorted_by</a>\<'a, F\>(&'a self, compare: F) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-47" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.is_sorted_by_key" class="fn">is_sorted_by_key</a>\<'a, F, K\>(&'a self, f: F) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-48" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.partition_point" class="fn">partition_point</a>\<P\>(&self, pred: P) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-49" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#panics-11" class="doc-anchor">§</a>Panics

Panics if `T` is zero-sized.

##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-50" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#panics-12" class="doc-anchor">§</a>Panics

Panics if `T` is zero-sized.

##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-51" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.to_vec" class="fn">to_vec</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<T\>
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-52" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.to_vec_in" class="fn">to_vec_in</a>\<A\>(&self, alloc: A) -\> <a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<T, A\>
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-53" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#panics-13" class="doc-anchor">§</a>Panics

This function will panic if the capacity would overflow.

##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-54" class="doc-anchor">§</a>Examples
...
<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#" class="tooltip" title="This example panics">ⓘ</a>
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-55" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-56" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#examples-57" class="doc-anchor">§</a>Examples
...
## Trait Implementations<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#trait-implementations" class="anchor">§</a>

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#impl-AsRef%3C%5BT%5D%3E-for-ScalarBuffer%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/nightly/core/convert/trait.AsRef.html" class="trait" title="trait core::convert::AsRef">AsRef</a>\<<a href="https://doc.rust-lang.org/nightly/std/primitive.slice.html" class="primitive">[T]</a>\> for <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>

where T: <a href="https://docs.rs/arrow/latest/arrow/datatypes/trait.ArrowNativeType.html" class="trait" title="trait arrow::datatypes::ArrowNativeType">ArrowNativeType</a>,

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.as_ref" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/convert/trait.AsRef.html#tymethod.as_ref" class="fn">as_ref</a>(&self) -\> &<a href="https://doc.rust-lang.org/nightly/std/primitive.slice.html" class="primitive">[T]</a>

Converts this type into a shared reference of the (usually inferred) input type.

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#impl-Clone-for-ScalarBuffer%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html" class="trait" title="trait core::clone::Clone">Clone</a> for <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>

where T: <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html" class="trait" title="trait core::clone::Clone">Clone</a> + <a href="https://docs.rs/arrow/latest/arrow/datatypes/trait.ArrowNativeType.html" class="trait" title="trait arrow::datatypes::ArrowNativeType">ArrowNativeType</a>,

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.clone" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone" class="fn">clone</a>(&self) -\> <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>

Returns a duplicate of the value. [Read more](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/clone.rs.html#245-247" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.clone_from" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#method.clone_from" class="fn">clone_from</a>(&mut self, source: &Self)

Performs copy-assignment from `source`. [Read more](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#method.clone_from)

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#impl-Debug-for-ScalarBuffer%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html" class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>

where T: <a href="https://docs.rs/arrow/latest/arrow/datatypes/trait.ArrowNativeType.html" class="trait" title="trait arrow::datatypes::ArrowNativeType">ArrowNativeType</a>,

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.fmt" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#impl-Default-for-ScalarBuffer%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/nightly/core/default/trait.Default.html" class="trait" title="trait core::default::Default">Default</a> for <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>

where T: <a href="https://doc.rust-lang.org/nightly/core/default/trait.Default.html" class="trait" title="trait core::default::Default">Default</a> + <a href="https://docs.rs/arrow/latest/arrow/datatypes/trait.ArrowNativeType.html" class="trait" title="trait arrow::datatypes::ArrowNativeType">ArrowNativeType</a>,

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.default" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default" class="fn">default</a>() -\> <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#impl-Deref-for-ScalarBuffer%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html" class="trait" title="trait core::ops::deref::Deref">Deref</a> for <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>

where T: <a href="https://docs.rs/arrow/latest/arrow/datatypes/trait.ArrowNativeType.html" class="trait" title="trait arrow::datatypes::ArrowNativeType">ArrowNativeType</a>,

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#associatedtype.Target" class="anchor">§</a>

#### type <a href="https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target" class="associatedtype">Target</a> = <a href="https://doc.rust-lang.org/nightly/std/primitive.slice.html" class="primitive">[T]</a>

The resulting type after dereferencing.

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.deref" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref" class="fn">deref</a>(&self) -\> &\<<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\> as <a href="https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html" class="trait" title="trait core::ops::deref::Deref">Deref</a>\>::<a href="https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target" class="associatedtype" title="type core::ops::deref::Deref::Target">Target</a>

Dereferences the value.

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#impl-From%3CBuffer%3E-for-ScalarBuffer%3CT%3E" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.from-2" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from" class="fn">from</a>(buffer: <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.Buffer.html" class="struct" title="struct arrow::buffer::Buffer">Buffer</a>) -\> <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>

Converts to this type from the input type.

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#impl-From%3CBufferBuilder%3CT%3E%3E-for-ScalarBuffer%3CT%3E" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.from-6" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from" class="fn">from</a>(value: <a href="https://docs.rs/arrow/latest/arrow/array/struct.BufferBuilder.html" class="struct" title="struct arrow::array::BufferBuilder">BufferBuilder</a>\<T\>) -\> <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>

Converts to this type from the input type.

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#impl-From%3CMutableBuffer%3E-for-ScalarBuffer%3CT%3E" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.from-1" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from" class="fn">from</a>(value: <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.MutableBuffer.html" class="struct" title="struct arrow::buffer::MutableBuffer">MutableBuffer</a>) -\> <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>

Converts to this type from the input type.

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#impl-From%3COffsetBuffer%3CT%3E%3E-for-ScalarBuffer%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html" class="trait" title="trait core::convert::From">From</a>\<<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.OffsetBuffer.html" class="struct" title="struct arrow::buffer::OffsetBuffer">OffsetBuffer</a>\<T\>\> for <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>

where T: <a href="https://docs.rs/arrow/latest/arrow/datatypes/trait.ArrowNativeType.html" class="trait" title="trait arrow::datatypes::ArrowNativeType">ArrowNativeType</a>,

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.from-3" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from" class="fn">from</a>(value: <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.OffsetBuffer.html" class="struct" title="struct arrow::buffer::OffsetBuffer">OffsetBuffer</a>\<T\>) -\> <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>

Converts to this type from the input type.

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#impl-From%3CScalarBuffer%3CT%3E%3E-for-Buffer" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.from" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#impl-From%3CScalarBuffer%3CT%3E%3E-for-Vec%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html" class="trait" title="trait core::convert::From">From</a>\<<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>\> for <a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<T\>

where T: <a href="https://docs.rs/arrow/latest/arrow/datatypes/trait.ArrowNativeType.html" class="trait" title="trait arrow::datatypes::ArrowNativeType">ArrowNativeType</a>,

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.from-5" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from" class="fn">from</a>(value: <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>) -\> <a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<T\>

Converts to this type from the input type.

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#impl-From%3CVec%3CT%3E%3E-for-ScalarBuffer%3CT%3E" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.from-4" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#impl-FromIterator%3CT%3E-for-ScalarBuffer%3CT%3E" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.from_iter" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html#tymethod.from_iter" class="fn">from_iter</a>\<I\>(iter: I) -\> <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>
...
<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#impl-IntoIterator-for-%26ScalarBuffer%3CT%3E" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#associatedtype.Item" class="anchor">§</a>

#### type <a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.Item" class="associatedtype">Item</a> = <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;'a T</a>

The type of the elements being iterated over.

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#associatedtype.IntoIter" class="anchor">§</a>

#### type <a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter" class="associatedtype">IntoIter</a> = <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.Iter.html" class="struct" title="struct core::slice::iter::Iter">Iter</a>\<'a, T\>

Which kind of iterator are we turning this into?

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.into_iter" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter" class="fn">into_iter</a>(self) -\> \<&'a <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\> as <a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html" class="trait" title="trait core::iter::traits::collect::IntoIterator">IntoIterator</a>\>::<a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter" class="associatedtype" title="type core::iter::traits::collect::IntoIterator::IntoIter">IntoIter</a>

Creates an iterator from a value. [Read more](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#impl-PartialEq%3CS%3E-for-ScalarBuffer%3CT%3E" class="anchor">§</a>

### impl\<T, S\> <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html" class="trait" title="trait core::cmp::PartialEq">PartialEq</a>\<S\> for <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>

where T: <a href="https://docs.rs/arrow/latest/arrow/datatypes/trait.ArrowNativeType.html" class="trait" title="trait arrow::datatypes::ArrowNativeType">ArrowNativeType</a>, S: <a href="https://doc.rust-lang.org/nightly/core/convert/trait.AsRef.html" class="trait" title="trait core::convert::AsRef">AsRef</a>\<<a href="https://doc.rust-lang.org/nightly/std/primitive.slice.html" class="primitive">[T]</a>\> + ?<a href="https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html" class="trait" title="trait core::marker::Sized">Sized</a>,

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.eq" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq" class="fn">eq</a>(&self, other: <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;S</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Tests for `self` and `other` values to be equal, and is used by `==`.

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#264" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.ne" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#method.ne" class="fn">ne</a>(&self, other: <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;Rhs</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Tests for `!=`. The default implementation is almost always sufficient, and should not be overridden without very good reason.

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#impl-PartialEq%3CScalarBuffer%3CT%3E%3E-for-%5BT%5D" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html" class="trait" title="trait core::cmp::PartialEq">PartialEq</a>\<<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>\> for <a href="https://doc.rust-lang.org/nightly/std/primitive.slice.html" class="primitive">[T]</a>

where T: <a href="https://docs.rs/arrow/latest/arrow/datatypes/trait.ArrowNativeType.html" class="trait" title="trait arrow::datatypes::ArrowNativeType">ArrowNativeType</a>,

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.eq-1" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq" class="fn">eq</a>(&self, other: &<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Tests for `self` and `other` values to be equal, and is used by `==`.

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#264" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.ne-1" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#method.ne" class="fn">ne</a>(&self, other: <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;Rhs</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Tests for `!=`. The default implementation is almost always sufficient, and should not be overridden without very good reason.

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#impl-PartialEq%3CScalarBuffer%3CT%3E%3E-for-Vec%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html" class="trait" title="trait core::cmp::PartialEq">PartialEq</a>\<<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>\> for <a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<T\>

where T: <a href="https://docs.rs/arrow/latest/arrow/datatypes/trait.ArrowNativeType.html" class="trait" title="trait arrow::datatypes::ArrowNativeType">ArrowNativeType</a>,

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.eq-2" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq" class="fn">eq</a>(&self, other: &<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Tests for `self` and `other` values to be equal, and is used by `==`.

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#264" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#method.ne-2" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#method.ne" class="fn">ne</a>(&self, other: <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;Rhs</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Tests for `!=`. The default implementation is almost always sufficient, and should not be overridden without very good reason.

<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#impl-Eq-for-ScalarBuffer%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html" class="trait" title="trait core::cmp::Eq">Eq</a> for <a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html" class="struct" title="struct arrow::buffer::ScalarBuffer">ScalarBuffer</a>\<T\>

where T: <a href="https://docs.rs/arrow/latest/arrow/datatypes/trait.ArrowNativeType.html" class="trait" title="trait arrow::datatypes::ArrowNativeType">ArrowNativeType</a> + <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html" class="trait" title="trait core::cmp::Eq">Eq</a>,

If T implements Eq, then so does ScalarBuffer.

## Auto Trait Implementations<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#synthetic-implementations" class="anchor">§</a>

## Blanket Implementations<a href="https://docs.rs/arrow/latest/arrow/buffer/struct.ScalarBuffer.html#blanket-implementations" class="anchor">§</a>
