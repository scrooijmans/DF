...
## Structs<a href="https://docs.rs/arrow/latest/arrow/array/ffi/index.html#structs" class="anchor">§</a>

<a href="https://docs.rs/arrow/latest/arrow/array/ffi/struct.FFI_ArrowArray.html" class="struct" title="struct arrow::array::ffi::FFI_ArrowArray">FFI_ArrowArray</a>  
...
<a href="https://docs.rs/arrow/latest/arrow/array/ffi/struct.FFI_ArrowSchema.html" class="struct" title="struct arrow::array::ffi::FFI_ArrowSchema">FFI_ArrowSchema</a>  
...
## Functions<a href="https://docs.rs/arrow/latest/arrow/array/ffi/index.html#functions" class="anchor">§</a>

<a href="https://docs.rs/arrow/latest/arrow/array/ffi/fn.export_array_into_raw.html" class="fn" title="fn arrow::array::ffi::export_array_into_raw">export_array_into_raw</a><sup>⚠</sup>Deprecated  
Exports an array to raw pointers of the C Data Interface provided by the consumer.

<a href="https://docs.rs/arrow/latest/arrow/array/ffi/fn.from_ffi.html" class="fn" title="fn arrow::array::ffi::from_ffi">from_ffi</a><sup>⚠</sup>  
...
<a href="https://docs.rs/arrow/latest/arrow/array/ffi/fn.from_ffi_and_data_type.html" class="fn" title="fn arrow::array::ffi::from_ffi_and_data_type">from_ffi_and_data_type</a><sup>⚠</sup>  
Import [ArrayData](https://docs.rs/arrow/latest/arrow/array/struct.ArrayData.html "struct arrow::array::ArrayData") from the C Data Interface

<a href="https://docs.rs/arrow/latest/arrow/array/ffi/fn.to_ffi.html" class="fn" title="fn arrow::array::ffi::to_ffi">to_ffi</a>  
