# Type Alias BinaryDictionaryBuilder Copy item path

<a href="https://docs.rs/arrow-array/56.2.0/x86_64-unknown-linux-gnu/src/arrow_array/builder/generic_bytes_dictionary_builder.rs.html#595" class="src">Source</a>
...
## Aliased Type<a href="https://docs.rs/arrow/latest/arrow/array/builder/type.BinaryDictionaryBuilder.html#aliased-type" class="anchor">§</a>

``` rust
pub struct BinaryDictionaryBuilder<K> { /* private fields */ }
```
