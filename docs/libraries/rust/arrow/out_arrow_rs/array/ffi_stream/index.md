...
<a href="https://docs.rs/arrow/latest/arrow/array/ffi_stream/index.html#" class="tooltip" title="This example is not tested">ⓘ</a>
...
## Structs<a href="https://docs.rs/arrow/latest/arrow/array/ffi_stream/index.html#structs" class="anchor">§</a>

<a href="https://docs.rs/arrow/latest/arrow/array/ffi_stream/struct.ArrowArrayStreamReader.html" class="struct" title="struct arrow::array::ffi_stream::ArrowArrayStreamReader">ArrowArrayStreamReader</a>  
A `RecordBatchReader` which imports Arrays from `FFI_ArrowArrayStream`.

<a href="https://docs.rs/arrow/latest/arrow/array/ffi_stream/struct.FFI_ArrowArrayStream.html" class="struct" title="struct arrow::array::ffi_stream::FFI_ArrowArrayStream">FFI_ArrowArrayStream</a>  
