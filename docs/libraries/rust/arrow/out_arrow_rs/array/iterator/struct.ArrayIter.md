# Struct ArrayIter Copy item path

<a href="https://docs.rs/arrow-array/56.2.0/x86_64-unknown-linux-gnu/src/arrow_array/iterator.rs.html#48" class="src">Source</a>

``` rust
pub struct ArrayIter<T>where
    T: ArrayAccessor,{ /* private fields */ }
```
...
## <a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#performance" class="doc-anchor">§</a>Performance

[`ArrayIter`](https://docs.rs/arrow/latest/arrow/array/struct.ArrayIter.html "struct arrow::array::ArrayIter") provides an idiomatic way to iterate over an array, however, this comes at the cost of performance. In particular the interleaved handling of the null mask is often sub-optimal.

If performing an infallible operation, it is typically faster to perform the operation on every index of the array, and handle the null mask separately. For [`PrimitiveArray`](https://docs.rs/arrow/latest/arrow/array/struct.PrimitiveArray.html "struct arrow::array::PrimitiveArray") this functionality is provided by [`compute::unary`](https://docs.rs/arrow/latest/arrow/compute/fn.unary.html)

If performing a fallible operation, it isn’t possible to perform the operation independently of the null mask, as this might result in a spurious failure on a null index. However, there are more efficient ways to iterate over just the non-null indices, this functionality is provided by [`compute::try_unary`](https://docs.rs/arrow/latest/arrow/compute/fn.try_unary.html)

## Implementations<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#implementations" class="anchor">§</a>

<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#impl-ArrayIter%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://docs.rs/arrow/latest/arrow/array/struct.ArrayIter.html" class="struct" title="struct arrow::array::ArrayIter">ArrayIter</a>\<T\>

where T: <a href="https://docs.rs/arrow/latest/arrow/array/trait.ArrayAccessor.html" class="trait" title="trait arrow::array::ArrayAccessor">ArrayAccessor</a>,

#### pub fn <a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.new" class="fn">new</a>(array: T) -\> <a href="https://docs.rs/arrow/latest/arrow/array/struct.ArrayIter.html" class="struct" title="struct arrow::array::ArrayIter">ArrayIter</a>\<T\> <a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#" class="tooltip" data-notable-ty="ArrayIter&lt;T&gt;">ⓘ</a>

create a new iterator

## Trait Implementations<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#trait-implementations" class="anchor">§</a>

<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#impl-Debug-for-ArrayIter%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html" class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="https://docs.rs/arrow/latest/arrow/array/struct.ArrayIter.html" class="struct" title="struct arrow::array::ArrayIter">ArrayIter</a>\<T\>

where T: <a href="https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html" class="trait" title="trait core::fmt::Debug">Debug</a> + <a href="https://docs.rs/arrow/latest/arrow/array/trait.ArrayAccessor.html" class="trait" title="trait arrow::array::ArrayAccessor">ArrayAccessor</a>,

<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.fmt" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#impl-DoubleEndedIterator-for-ArrayIter%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/nightly/core/iter/traits/double_ended/trait.DoubleEndedIterator.html" class="trait" title="trait core::iter::traits::double_ended::DoubleEndedIterator">DoubleEndedIterator</a> for <a href="https://docs.rs/arrow/latest/arrow/array/struct.ArrayIter.html" class="struct" title="struct arrow::array::ArrayIter">ArrayIter</a>\<T\>

where T: <a href="https://docs.rs/arrow/latest/arrow/array/trait.ArrayAccessor.html" class="trait" title="trait arrow::array::ArrayAccessor">ArrayAccessor</a>,

<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.next_back" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/iter/traits/double_ended/trait.DoubleEndedIterator.html#tymethod.next_back" class="fn">next_back</a>(&mut self) -\> <a href="https://doc.rust-lang.org/nightly/core/option/enum.Option.html" class="enum" title="enum core::option::Option">Option</a>\<\<<a href="https://docs.rs/arrow/latest/arrow/array/struct.ArrayIter.html" class="struct" title="struct arrow::array::ArrayIter">ArrayIter</a>\<T\> as <a href="https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html" class="trait" title="trait core::iter::traits::iterator::Iterator">Iterator</a>\>::<a href="https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#associatedtype.Item" class="associatedtype" title="type core::iter::traits::iterator::Iterator::Item">Item</a>\>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.advance_back_by" class="anchor">§</a>
...
1.37.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/double_ended.rs.html#191" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.nth_back" class="anchor">§</a>
...
1.27.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/double_ended.rs.html#230-234" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.try_rfold" class="anchor">§</a>
...
1.27.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/double_ended.rs.html#301-304" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.rfold" class="anchor">§</a>
...
1.27.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/double_ended.rs.html#356-359" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.rfind" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#impl-ExactSizeIterator-for-ArrayIter%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/nightly/core/iter/traits/exact_size/trait.ExactSizeIterator.html" class="trait" title="trait core::iter::traits::exact_size::ExactSizeIterator">ExactSizeIterator</a> for <a href="https://docs.rs/arrow/latest/arrow/array/struct.ArrayIter.html" class="struct" title="struct arrow::array::ArrayIter">ArrayIter</a>\<T\>

where T: <a href="https://docs.rs/arrow/latest/arrow/array/trait.ArrayAccessor.html" class="trait" title="trait arrow::array::ArrayAccessor">ArrayAccessor</a>,

all arrays have known size.

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/exact_size.rs.html#116" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.len" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.is_empty" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#impl-Iterator-for-ArrayIter%3CT%3E" class="anchor">§</a>

### impl\<T\> <a href="https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html" class="trait" title="trait core::iter::traits::iterator::Iterator">Iterator</a> for <a href="https://docs.rs/arrow/latest/arrow/array/struct.ArrayIter.html" class="struct" title="struct arrow::array::ArrayIter">ArrayIter</a>\<T\>

where T: <a href="https://docs.rs/arrow/latest/arrow/array/trait.ArrayAccessor.html" class="trait" title="trait arrow::array::ArrayAccessor">ArrayAccessor</a>,

<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#associatedtype.Item" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.next" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.size_hint" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.next_chunk" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#222-224" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.count" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#250-252" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.last" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.advance_by" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#374" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.nth" class="anchor">§</a>
...
1.28.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#424-426" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.step_by" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#613-616" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.zip" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.intersperse" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.intersperse_with" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#773-776" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.map" class="anchor">§</a>
...
1.21.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#818-821" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.for_each" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#893-896" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.filter" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#938-941" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.filter_map" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#985-987" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.enumerate" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1056-1058" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.peekable" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1121-1124" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.skip_while" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1199-1202" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.take_while" class="anchor">§</a>
...
1.57.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1287-1290" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.map_while" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1316-1318" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.skip" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1388-1390" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.take" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1435-1438" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.scan" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1473-1477" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.flat_map" class="anchor">§</a>
...
1.29.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1557-1560" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.flatten" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.map_windows" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1775-1777" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.fuse" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1859-1862" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.inspect" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1896-1898" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.by_ref" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#2015-2017" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.collect" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.try_collect" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.collect_into" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#2206-2210" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.partition" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.partition_in_place" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.is_partitioned" class="anchor">§</a>
...
1.27.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#2419-2423" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.try_fold" class="anchor">§</a>
...
1.27.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#2477-2481" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.try_for_each" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#2596-2599" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.fold" class="anchor">§</a>
...
1.51.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#2633-2636" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.reduce" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.try_reduce" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#2762-2765" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.all" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#2815-2818" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.any" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#2877-2880" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.find" class="anchor">§</a>
...
1.30.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#2908-2911" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.find_map" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.try_find" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3049-3052" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.position" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3114-3117" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.rposition" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3163-3166" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.max" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3199-3202" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.min" class="anchor">§</a>
...
1.6.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3221-3224" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.max_by_key" class="anchor">§</a>
...
1.15.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3254-3257" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.max_by" class="anchor">§</a>
...
1.6.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3281-3284" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.min_by_key" class="anchor">§</a>
...
1.15.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3314-3317" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.min_by" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3351-3353" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.rev" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3387-3391" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.unzip" class="anchor">§</a>
...
1.36.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3418-3421" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.copied" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3466-3469" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.cloned" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3497-3499" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.cycle" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.array_chunks" class="anchor">§</a>
...
1.11.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3576-3579" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.sum" class="anchor">§</a>
...
1.11.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3608-3611" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.product" class="anchor">§</a>
...
1.5.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3629-3633" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.cmp" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.cmp_by" class="anchor">§</a>
...
1.5.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3712-3716" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.partial_cmp" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.partial_cmp_by" class="anchor">§</a>
...
1.5.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3781-3785" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.eq" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.eq_by" class="anchor">§</a>
...
1.5.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3833-3837" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.ne" class="anchor">§</a>
...
1.5.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3854-3858" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.lt" class="anchor">§</a>
...
1.5.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3875-3879" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.le" class="anchor">§</a>
...
1.5.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3896-3900" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.gt" class="anchor">§</a>
...
1.5.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3917-3921" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.ge" class="anchor">§</a>
...
1.82.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3946-3949" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.is_sorted" class="anchor">§</a>
...
1.82.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3972-3975" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.is_sorted_by" class="anchor">§</a>
...
1.82.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#4016-4020" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#method.is_sorted_by_key" class="anchor">§</a>
...
## Auto Trait Implementations<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#synthetic-implementations" class="anchor">§</a>

## Blanket Implementations<a href="https://docs.rs/arrow/latest/arrow/array/iterator/struct.ArrayIter.html#blanket-implementations" class="anchor">§</a>
