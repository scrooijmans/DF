...
## <a href="https://docs.rs/arrow/latest/arrow/compute/fn.take_arrays.html#errors" class="doc-anchor">§</a>Errors
...
## <a href="https://docs.rs/arrow/latest/arrow/compute/fn.take_arrays.html#safety" class="doc-anchor">§</a>Safety

When `options` is not set to check bounds, taking indexes after `len` will panic.

## <a href="https://docs.rs/arrow/latest/arrow/compute/fn.take_arrays.html#examples" class="doc-anchor">§</a>Examples
