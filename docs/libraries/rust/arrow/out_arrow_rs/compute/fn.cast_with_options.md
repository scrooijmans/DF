...
## <a href="https://docs.rs/arrow/latest/arrow/compute/fn.cast_with_options.html#behavior" class="doc-anchor">§</a>Behavior
...
## <a href="https://docs.rs/arrow/latest/arrow/compute/fn.cast_with_options.html#durations-and-intervals" class="doc-anchor">§</a>Durations and Intervals
...
## <a href="https://docs.rs/arrow/latest/arrow/compute/fn.cast_with_options.html#timestamps-and-timezones" class="doc-anchor">§</a>Timestamps and Timezones

Timestamps are stored with an optional timezone in Arrow.

### <a href="https://docs.rs/arrow/latest/arrow/compute/fn.cast_with_options.html#casting-timestamps-to-a-timestamp-without-timezone--utc" class="doc-anchor">§</a>Casting timestamps to a timestamp without timezone / UTC
...
### <a href="https://docs.rs/arrow/latest/arrow/compute/fn.cast_with_options.html#casting-timestamps-to-a-timestamp-with-timezone" class="doc-anchor">§</a>Casting timestamps to a timestamp with timezone
...
## <a href="https://docs.rs/arrow/latest/arrow/compute/fn.cast_with_options.html#casting-timestamps-without-timezone-to-timestamps-with-timezone" class="doc-anchor">§</a>Casting timestamps without timezone to timestamps with timezone
