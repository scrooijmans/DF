...
<a href="https://docs.rs/arrow-select/56.2.0/x86_64-unknown-linux-gnu/src/arrow_select/take.rs.html#86-90" class="src">Source</a>
...
For selecting values by index from multiple arrays see [`crate::interleave`](https://docs.rs/arrow/latest/arrow/compute/kernels/interleave/index.html "mod arrow::compute::kernels::interleave")
...
## <a href="https://docs.rs/arrow/latest/arrow/compute/kernels/take/fn.take.html#errors" class="doc-anchor">§</a>Errors
...
## <a href="https://docs.rs/arrow/latest/arrow/compute/kernels/take/fn.take.html#safety" class="doc-anchor">§</a>Safety

When `options` is not set to check bounds, taking indexes after `len` will panic.

## <a href="https://docs.rs/arrow/latest/arrow/compute/kernels/take/fn.take.html#see-also" class="doc-anchor">§</a>See also
...
## <a href="https://docs.rs/arrow/latest/arrow/compute/kernels/take/fn.take.html#examples" class="doc-anchor">§</a>Examples
