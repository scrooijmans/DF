...
<a href="https://docs.rs/arrow-schema/56.2.0/x86_64-unknown-linux-gnu/src/arrow_schema/fields.rs.html#60" class="src">Source</a>
...
See [`SchemaBuilder`](https://docs.rs/arrow/latest/arrow/datatypes/struct.SchemaBuilder.html "struct arrow::datatypes::SchemaBuilder") for mutating or updating [`Fields`](https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html "struct arrow::datatypes::Fields")
...
## Implementations<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#implementations" class="anchor">§</a>

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#impl-Fields" class="anchor">§</a>

### impl <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>

#### pub fn <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.empty" class="fn">empty</a>() -\> <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>

Returns a new empty [`Fields`](https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html "struct arrow::datatypes::Fields")

#### pub fn <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.size" class="fn">size</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>
...
In particular returns true if both have the same number of fields, and [`Field::contains`](https://docs.rs/arrow/latest/arrow/datatypes/struct.Field.html#method.contains "method arrow::datatypes::Field::contains") for each field across self and other

In other words, any record that conforms to `other` should also conform to `self`

#### pub fn <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.filter_leaves" class="fn">filter_leaves</a>\<F\>(&self, filter: F) -\> <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>
...
Returns a copy of this [`Fields`](https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html "struct arrow::datatypes::Fields") containing only those [`FieldRef`](https://docs.rs/arrow/latest/arrow/datatypes/type.FieldRef.html "type arrow::datatypes::FieldRef") passing a predicate

Performs a depth-first scan of [`Fields`](https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html "struct arrow::datatypes::Fields") invoking `filter` for each [`FieldRef`](https://docs.rs/arrow/latest/arrow/datatypes/type.FieldRef.html "type arrow::datatypes::FieldRef") containing no child [`FieldRef`](https://docs.rs/arrow/latest/arrow/datatypes/type.FieldRef.html "type arrow::datatypes::FieldRef"), a leaf field, along with a count of the number of such leaves encountered so far. Only [`FieldRef`](https://docs.rs/arrow/latest/arrow/datatypes/type.FieldRef.html "type arrow::datatypes::FieldRef") for which `filter` returned `true` will be included in the result.

This can therefore be used to select a subset of fields from nested types such as [`DataType::Struct`](https://docs.rs/arrow/latest/arrow/datatypes/enum.DataType.html#variant.Struct "variant arrow::datatypes::DataType::Struct") or [`DataType::List`](https://docs.rs/arrow/latest/arrow/datatypes/enum.DataType.html#variant.List "variant arrow::datatypes::DataType::List").
...
where F: <a href="https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html" class="trait" title="trait core::ops::function::FnMut">FnMut</a>(<a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>, &<a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Field.html" class="struct" title="struct arrow::datatypes::Field">Field</a>\>) -\> <a href="https://doc.rust-lang.org/nightly/core/result/enum.Result.html" class="enum" title="enum core::result::Result">Result</a>\<<a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>, <a href="https://docs.rs/arrow/latest/arrow/error/enum.ArrowError.html" class="enum" title="enum arrow::error::ArrowError">ArrowError</a>\>,

Returns a copy of this [`Fields`](https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html "struct arrow::datatypes::Fields") containing only those [`FieldRef`](https://docs.rs/arrow/latest/arrow/datatypes/type.FieldRef.html "type arrow::datatypes::FieldRef") passing a predicate or an error if the predicate fails.

See [`Fields::filter_leaves`](https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.filter_leaves "method arrow::datatypes::Fields::filter_leaves") for more information.

## Methods from <a href="https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html" class="trait" title="trait core::ops::deref::Deref">Deref</a>\<Target = \[<a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Field.html" class="struct" title="struct arrow::datatypes::Field">Field</a>\>\]\><a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#deref-methods-%5BArc%3CField%3E%5D" class="anchor">§</a>

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/slice/mod.rs.html#114" class="src">Source</a>

#### pub fn <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.len" class="fn">len</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>

Returns the number of elements in the slice.

##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.is_empty" class="fn">is_empty</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Returns `true` if the slice has a length of 0.

##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-1" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-2" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-3" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-4" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-5" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-6" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-7" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-8" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-9" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-10" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#safety" class="doc-anchor">§</a>Safety
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-11" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.as_ptr" class="fn">as_ptr</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.pointer.html" class="primitive">*const T</a>
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-12" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.iter" class="fn">iter</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.Iter.html" class="struct" title="struct core::slice::iter::Iter">Iter</a>\<'\_, T\>

Returns an iterator over the slice.

The iterator yields all items from start to end.

##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-13" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#panics" class="doc-anchor">§</a>Panics

Panics if `size` is zero.

##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-14" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#panics-1" class="doc-anchor">§</a>Panics

Panics if `chunk_size` is zero.

##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-15" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#panics-2" class="doc-anchor">§</a>Panics

Panics if `chunk_size` is zero.

##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-16" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#safety-1" class="doc-anchor">§</a>Safety
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-17" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#panics-3" class="doc-anchor">§</a>Panics
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-18" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#panics-4" class="doc-anchor">§</a>Panics

Panics if `N` is zero.

Note that this check is against a const generic parameter, not a runtime value, and thus a particular monomorphization will either always panic or it will never panic.

##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-19" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#panics-5" class="doc-anchor">§</a>Panics

Panics if `N` is zero. This check will most probably get changed to a compile time error before this method gets stabilized.

##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-20" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#panics-6" class="doc-anchor">§</a>Panics

Panics if `chunk_size` is zero.

##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-21" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#panics-7" class="doc-anchor">§</a>Panics

Panics if `chunk_size` is zero.

##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-22" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.chunk_by" class="fn">chunk_by</a>\<F\>(&self, pred: F) -\> <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.ChunkBy.html" class="struct" title="struct core::slice::iter::ChunkBy">ChunkBy</a>\<'\_, T, F\>
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-23" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#panics-8" class="doc-anchor">§</a>Panics
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-24" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#safety-2" class="doc-anchor">§</a>Safety
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-25" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-26" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.split" class="fn">split</a>\<F\>(&self, pred: F) -\> <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.Split.html" class="struct" title="struct core::slice::iter::Split">Split</a>\<'\_, T, F\>
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-27" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-28" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.rsplit" class="fn">rsplit</a>\<F\>(&self, pred: F) -\> <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.RSplit.html" class="struct" title="struct core::slice::iter::RSplit">RSplit</a>\<'\_, T, F\>

where F: <a href="https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html" class="trait" title="trait core::ops::function::FnMut">FnMut</a>(<a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;T</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>,

Returns an iterator over subslices separated by elements that match `pred`, starting at the end of the slice and working backwards. The matched element is not contained in the subslices.

##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-29" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-30" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-31" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-32" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-33" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.contains-1" class="fn">contains</a>(&self, x: <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;T</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-34" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.starts_with" class="fn">starts_with</a>(&self, needle: &<a href="https://doc.rust-lang.org/nightly/std/primitive.slice.html" class="primitive">[T]</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

where T: <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html" class="trait" title="trait core::cmp::PartialEq">PartialEq</a>,

Returns `true` if `needle` is a prefix of the slice or equal to the slice.

##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-35" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.ends_with" class="fn">ends_with</a>(&self, needle: &<a href="https://doc.rust-lang.org/nightly/std/primitive.slice.html" class="primitive">[T]</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

where T: <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html" class="trait" title="trait core::cmp::PartialEq">PartialEq</a>,

Returns `true` if `needle` is a suffix of the slice or equal to the slice.

##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-36" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-37" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-38" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-39" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-40" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-41" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-42" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-43" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#safety-3" class="doc-anchor">§</a>Safety

This method is essentially a `transmute` with respect to the elements in the returned middle slice, so all the usual caveats pertaining to `transmute::<T, U>` also apply here.

##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-44" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#panics-9" class="doc-anchor">§</a>Panics

This will panic if the size of the SIMD type is different from `LANES` times that of the scalar.

At the time of writing, the trait restrictions on `Simd<T, LANES>` keeps that from ever happening, as only power-of-two numbers of lanes are supported. It’s possible that, in the future, those restrictions might be lifted in a way that would make it possible to see panics from this method for something like `LANES == 3`.

##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-45" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.is_sorted" class="fn">is_sorted</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-46" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.is_sorted_by" class="fn">is_sorted_by</a>\<'a, F\>(&'a self, compare: F) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-47" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.is_sorted_by_key" class="fn">is_sorted_by_key</a>\<'a, F, K\>(&'a self, f: F) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-48" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.partition_point" class="fn">partition_point</a>\<P\>(&self, pred: P) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-49" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#panics-10" class="doc-anchor">§</a>Panics

Panics if `T` is zero-sized.

##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-50" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#panics-11" class="doc-anchor">§</a>Panics

Panics if `T` is zero-sized.

##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-51" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.to_vec" class="fn">to_vec</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<T\>
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-52" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.to_vec_in" class="fn">to_vec_in</a>\<A\>(&self, alloc: A) -\> <a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<T, A\>
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-53" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#panics-12" class="doc-anchor">§</a>Panics

This function will panic if the capacity would overflow.

##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-54" class="doc-anchor">§</a>Examples
...
<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#" class="tooltip" title="This example panics">ⓘ</a>
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-55" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-56" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#examples-57" class="doc-anchor">§</a>Examples
...
## Trait Implementations<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#trait-implementations" class="anchor">§</a>

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#impl-Clone-for-Fields" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html" class="trait" title="trait core::clone::Clone">Clone</a> for <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.clone" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone" class="fn">clone</a>(&self) -\> <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>

Returns a duplicate of the value. [Read more](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/clone.rs.html#245-247" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.clone_from" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#method.clone_from" class="fn">clone_from</a>(&mut self, source: &Self)

Performs copy-assignment from `source`. [Read more](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#method.clone_from)

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#impl-Debug-for-Fields" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html" class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.fmt" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#impl-Default-for-Fields" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/default/trait.Default.html" class="trait" title="trait core::default::Default">Default</a> for <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.default" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default" class="fn">default</a>() -\> <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#impl-Deref-for-Fields" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html" class="trait" title="trait core::ops::deref::Deref">Deref</a> for <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#associatedtype.Target" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.deref" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#impl-From%3C%26%5BArc%3CField%3E%5D%3E-for-Fields" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.from-2" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#impl-From%3C%26Fields%3E-for-SchemaBuilder" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.from-4" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from" class="fn">from</a>(value: &<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>) -\> <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.SchemaBuilder.html" class="struct" title="struct arrow::datatypes::SchemaBuilder">SchemaBuilder</a>

Converts to this type from the input type.

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#impl-From%3C%5BArc%3CField%3E;+N%5D%3E-for-Fields" class="anchor">§</a>

### impl\<const N: <a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>\> <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html" class="trait" title="trait core::convert::From">From</a>\<\[<a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Field.html" class="struct" title="struct arrow::datatypes::Field">Field</a>\>; <a href="https://doc.rust-lang.org/nightly/std/primitive.array.html" class="primitive">N</a>\]\> for <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.from-3" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from" class="fn">from</a>(value: \[<a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Field.html" class="struct" title="struct arrow::datatypes::Field">Field</a>\>; <a href="https://doc.rust-lang.org/nightly/std/primitive.array.html" class="primitive">N</a>\]) -\> <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>

Converts to this type from the input type.

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#impl-From%3CFields%3E-for-SchemaBuilder" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html" class="trait" title="trait core::convert::From">From</a>\<<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>\> for <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.SchemaBuilder.html" class="struct" title="struct arrow::datatypes::SchemaBuilder">SchemaBuilder</a>

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.from-5" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from" class="fn">from</a>(value: <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>) -\> <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.SchemaBuilder.html" class="struct" title="struct arrow::datatypes::SchemaBuilder">SchemaBuilder</a>

Converts to this type from the input type.

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#impl-From%3CVec%3CArc%3CField%3E%3E%3E-for-Fields" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.from-1" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#impl-From%3CVec%3CField%3E%3E-for-Fields" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.from" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#impl-FromIterator%3CArc%3CField%3E%3E-for-Fields" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.from_iter-1" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#impl-FromIterator%3CField%3E-for-Fields" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html" class="trait" title="trait core::iter::traits::collect::FromIterator">FromIterator</a>\<<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Field.html" class="struct" title="struct arrow::datatypes::Field">Field</a>\> for <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.from_iter" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#impl-Hash-for-Fields" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html" class="trait" title="trait core::hash::Hash">Hash</a> for <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.hash" class="anchor">§</a>
...
1.3.0 · <a href="https://doc.rust-lang.org/nightly/src/core/hash/mod.rs.html#235-237" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.hash_slice" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#impl-IntoIterator-for-%26Fields" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#associatedtype.Item" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#associatedtype.IntoIter" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.into_iter" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#impl-Ord-for-Fields" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html" class="trait" title="trait core::cmp::Ord">Ord</a> for <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.cmp" class="anchor">§</a>
...
1.21.0 · <a href="https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#1021-1023" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.max" class="anchor">§</a>
...
1.21.0 · <a href="https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#1060-1062" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.min" class="anchor">§</a>
...
1.50.0 · <a href="https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#1086-1088" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.clamp" class="anchor">§</a>
...
<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#impl-PartialEq-for-Fields" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html" class="trait" title="trait core::cmp::PartialEq">PartialEq</a> for <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.eq" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq" class="fn">eq</a>(&self, other: &<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Tests for `self` and `other` values to be equal, and is used by `==`.

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#264" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.ne" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#method.ne" class="fn">ne</a>(&self, other: <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;Rhs</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Tests for `!=`. The default implementation is almost always sufficient, and should not be overridden without very good reason.

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#impl-PartialOrd-for-Fields" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html" class="trait" title="trait core::cmp::PartialOrd">PartialOrd</a> for <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.partial_cmp" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#1398" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.lt" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#method.lt" class="fn">lt</a>(&self, other: <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;Rhs</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Tests less than (for `self` and `other`) and is used by the `<` operator. [Read more](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#method.lt)

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#1416" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.le" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#method.le" class="fn">le</a>(&self, other: <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;Rhs</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Tests less than or equal to (for `self` and `other`) and is used by the `<=` operator. [Read more](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#method.le)

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#1434" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.gt" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#method.gt" class="fn">gt</a>(&self, other: <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;Rhs</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Tests greater than (for `self` and `other`) and is used by the `>` operator. [Read more](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#method.gt)

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#1452" class="src">Source</a><a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#method.ge" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#method.ge" class="fn">ge</a>(&self, other: <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;Rhs</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Tests greater than or equal to (for `self` and `other`) and is used by the `>=` operator. [Read more](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#method.ge)

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#impl-Eq-for-Fields" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html" class="trait" title="trait core::cmp::Eq">Eq</a> for <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>

<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#impl-StructuralPartialEq-for-Fields" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html" class="trait" title="trait core::marker::StructuralPartialEq">StructuralPartialEq</a> for <a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html" class="struct" title="struct arrow::datatypes::Fields">Fields</a>

## Auto Trait Implementations<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#synthetic-implementations" class="anchor">§</a>

## Blanket Implementations<a href="https://docs.rs/arrow/latest/arrow/datatypes/struct.Fields.html#blanket-implementations" class="anchor">§</a>
