...
*   All packages share a common [output directory](build-cache.html), which defaults to a directory named `target` in the _workspace root_.
...
[](../reference/rust-version.html "Previous chapter")
[](../reference/specifying-dependencies.html "Next chapter")
