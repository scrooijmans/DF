# RegisterFunction in datafusion::execution::context - Rust

[datafusion](../../index.html)::[execution](../index.html)::[context](index.html)

## Enum RegisterFunction 

[Source](about:blank/src/datafusion/execution/context/mod.rs.html#1784-1793)
...
### Scalar([Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[ScalarUDF](../../logical_expr/struct.ScalarUDF.html "struct datafusion::logical_expr::ScalarUDF")\>)

Scalar user defined function

[§](#variant.Aggregate)

### Aggregate([Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[AggregateUDF](../../logical_expr/struct.AggregateUDF.html "struct datafusion::logical_expr::AggregateUDF")\>)

Aggregate user defined function

[§](#variant.Window)

### Window([Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[WindowUDF](../../logical_expr/struct.WindowUDF.html "struct datafusion::logical_expr::WindowUDF")\>)

Window user defined function

[§](#variant.Table)

### Table([String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String"), [Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<dyn [TableFunctionImpl](../../catalog/trait.TableFunctionImpl.html "trait datafusion::catalog::TableFunctionImpl")\>)

Table user defined function

## Auto Trait Implementations[§](#synthetic-implementations)

[§](#impl-Freeze-for-RegisterFunction)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RegisterFunction](enum.RegisterFunction.html "enum datafusion::execution::context::RegisterFunction")

[§](#impl-RefUnwindSafe-for-RegisterFunction)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RegisterFunction](enum.RegisterFunction.html "enum datafusion::execution::context::RegisterFunction")

[§](#impl-Send-for-RegisterFunction)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RegisterFunction](enum.RegisterFunction.html "enum datafusion::execution::context::RegisterFunction")

[§](#impl-Sync-for-RegisterFunction)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RegisterFunction](enum.RegisterFunction.html "enum datafusion::execution::context::RegisterFunction")

[§](#impl-Unpin-for-RegisterFunction)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RegisterFunction](enum.RegisterFunction.html "enum datafusion::execution::context::RegisterFunction")

[§](#impl-UnwindSafe-for-RegisterFunction)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RegisterFunction](enum.RegisterFunction.html "enum datafusion::execution::context::RegisterFunction")
