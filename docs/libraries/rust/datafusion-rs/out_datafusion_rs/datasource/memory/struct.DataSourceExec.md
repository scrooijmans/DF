# Struct DataSourceExec Copy item path

<a href="https://docs.rs/datafusion-datasource/50.2.0/x86_64-unknown-linux-gnu/src/datafusion_datasource/source.rs.html#193" class="src">Source</a>
...
The [`DataSource`](https://docs.rs/datafusion/50.2.0/datafusion/datasource/source/trait.DataSource.html "trait datafusion::datasource::source::DataSource") describes where to find the data for this data source (for example in files or what in memory partitions).

For file based [`DataSource`](https://docs.rs/datafusion/50.2.0/datafusion/datasource/source/trait.DataSource.html "trait datafusion::datasource::source::DataSource")s, format specific behavior is implemented in the [`FileSource`](https://docs.rs/datafusion/50.2.0/datafusion/datasource/physical_plan/trait.FileSource.html "trait datafusion::datasource::physical_plan::FileSource") trait.

## Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#implementations" class="anchor">§</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#impl-DataSourceExec" class="anchor">§</a>

### impl <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html" class="struct" title="struct datafusion::datasource::memory::DataSourceExec">DataSourceExec</a>

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.from_data_source" class="fn">from_data_source</a>( data_source: impl <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/source/trait.DataSource.html" class="trait" title="trait datafusion::datasource::source::DataSource">DataSource</a> + 'static, ) -\> <a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html" class="struct" title="struct datafusion::datasource::memory::DataSourceExec">DataSourceExec</a>\>

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.new" class="fn">new</a>(data_source: <a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<dyn <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/source/trait.DataSource.html" class="trait" title="trait datafusion::datasource::source::DataSource">DataSource</a>\>) -\> <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html" class="struct" title="struct datafusion::datasource::memory::DataSourceExec">DataSourceExec</a>

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.data_source" class="fn">data_source</a>(&self) -\> &<a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<dyn <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/source/trait.DataSource.html" class="trait" title="trait datafusion::datasource::source::DataSource">DataSource</a>\>

Return the source object

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.with_data_source" class="fn">with_data_source</a>( self, data_source: <a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<dyn <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/source/trait.DataSource.html" class="trait" title="trait datafusion::datasource::source::DataSource">DataSource</a>\>, ) -\> <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html" class="struct" title="struct datafusion::datasource::memory::DataSourceExec">DataSourceExec</a>
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.downcast_to_file_source" class="fn">downcast_to_file_source</a>\<T\>(&self) -\> <a href="https://doc.rust-lang.org/nightly/core/option/enum.Option.html" class="enum" title="enum core::option::Option">Option</a>\<(&<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/physical_plan/struct.FileScanConfig.html" class="struct" title="struct datafusion::datasource::physical_plan::FileScanConfig">FileScanConfig</a>, <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;T</a>)\>
...
2.  The [`FileScanConfig::file_source`](https://docs.rs/datafusion/50.2.0/datafusion/datasource/physical_plan/struct.FileScanConfig.html#method.file_source "method datafusion::datasource::physical_plan::FileScanConfig::file_source") is not of type `T`

## Trait Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#trait-implementations" class="anchor">§</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#impl-Clone-for-DataSourceExec" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html" class="trait" title="trait core::clone::Clone">Clone</a> for <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html" class="struct" title="struct datafusion::datasource::memory::DataSourceExec">DataSourceExec</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.clone" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone" class="fn">clone</a>(&self) -\> <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html" class="struct" title="struct datafusion::datasource::memory::DataSourceExec">DataSourceExec</a>

Returns a duplicate of the value. [Read more](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/clone.rs.html#245-247" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.clone_from" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#method.clone_from" class="fn">clone_from</a>(&mut self, source: &Self)

Performs copy-assignment from `source`. [Read more](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#method.clone_from)

<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#impl-Debug-for-DataSourceExec" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html" class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html" class="struct" title="struct datafusion::datasource::memory::DataSourceExec">DataSourceExec</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.fmt" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#impl-DisplayAs-for-DataSourceExec" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.fmt_as" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#impl-ExecutionPlan-for-DataSourceExec" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.repartitioned" class="anchor">§</a>

#### fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/trait.ExecutionPlan.html#method.repartitioned" class="fn">repartitioned</a>( &self, target_partitions: <a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>, config: &<a href="https://docs.rs/datafusion/50.2.0/datafusion/config/struct.ConfigOptions.html" class="struct" title="struct datafusion::config::ConfigOptions">ConfigOptions</a>, ) -\> <a href="https://doc.rust-lang.org/nightly/core/result/enum.Result.html" class="enum" title="enum core::result::Result">Result</a>\<<a href="https://doc.rust-lang.org/nightly/core/option/enum.Option.html" class="enum" title="enum core::option::Option">Option</a>\<<a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<dyn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/trait.ExecutionPlan.html" class="trait" title="trait datafusion::physical_plan::ExecutionPlan">ExecutionPlan</a>\>\>, <a href="https://docs.rs/datafusion/50.2.0/datafusion/error/enum.DataFusionError.html" class="enum" title="enum datafusion::error::DataFusionError">DataFusionError</a>\>

Implementation of [`ExecutionPlan::repartitioned`](https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/trait.ExecutionPlan.html#method.repartitioned "method datafusion::physical_plan::ExecutionPlan::repartitioned") which relies upon the inner [`DataSource::repartitioned`](https://docs.rs/datafusion/50.2.0/datafusion/datasource/source/trait.DataSource.html#method.repartitioned "method datafusion::datasource::source::DataSource::repartitioned").

If the data source does not support changing its partitioning, returns `Ok(None)` (the default). Refer to [`ExecutionPlan::repartitioned`](https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/trait.ExecutionPlan.html#method.repartitioned "method datafusion::physical_plan::ExecutionPlan::repartitioned") for more details.

<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.name" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.as_any" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.properties" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.children" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.metrics" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.partition_statistics" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.with_fetch" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.fetch" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.try_swapping_with_projection" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.static_name" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.schema" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.check_invariants" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.required_input_distribution" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.required_input_ordering" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.maintains_input_order" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.benefits_from_input_partitioning" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.reset_state" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.statistics" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.supports_limit_pushdown" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.cardinality_effect" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.gather_filters_for_pushdown" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.with_new_state" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#impl-From%3CS%3E-for-DataSourceExec" class="anchor">§</a>

### impl\<S\> <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html" class="trait" title="trait core::convert::From">From</a>\<S\> for <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html" class="struct" title="struct datafusion::datasource::memory::DataSourceExec">DataSourceExec</a>

where S: <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/source/trait.DataSource.html" class="trait" title="trait datafusion::datasource::source::DataSource">DataSource</a> + 'static,

Create a new `DataSourceExec` from a `DataSource`

<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#method.from" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from" class="fn">from</a>(source: S) -\> <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html" class="struct" title="struct datafusion::datasource::memory::DataSourceExec">DataSourceExec</a>

Converts to this type from the input type.

## Auto Trait Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#synthetic-implementations" class="anchor">§</a>

## Blanket Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/memory/struct.DataSourceExec.html#blanket-implementations" class="anchor">§</a>
