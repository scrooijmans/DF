# Struct StreamTable Copy item path

<a href="https://docs.rs/datafusion-catalog/50.2.0/x86_64-unknown-linux-gnu/src/datafusion_catalog/stream.rs.html#295" class="src">Source</a>

``` rust
pub struct StreamTable(/* private fields */);
```
...
Currently only reading from / appending to a single file in-place is supported, but other stream sources and sinks may be added in future.

Applications looking to read/write datasets comprising multiple files, e.g. [Hadoop](https://hadoop.apache.org/)-style data stored in object storage, should instead consider [`ListingTable`](https://docs.rs/datafusion/latest/datafusion/datasource/listing/struct.ListingTable.html).

## Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html#implementations" class="anchor">§</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html#impl-StreamTable" class="anchor">§</a>

### impl <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html" class="struct" title="struct datafusion::datasource::stream::StreamTable">StreamTable</a>

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html#method.new" class="fn">new</a>(config: <a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamConfig.html" class="struct" title="struct datafusion::datasource::stream::StreamConfig">StreamConfig</a>\>) -\> <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html" class="struct" title="struct datafusion::datasource::stream::StreamTable">StreamTable</a>

Create a new [`StreamTable`](https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html "struct datafusion::datasource::stream::StreamTable") for the given [`StreamConfig`](https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamConfig.html "struct datafusion::datasource::stream::StreamConfig")

## Trait Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html#trait-implementations" class="anchor">§</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html#impl-Debug-for-StreamTable" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html" class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html" class="struct" title="struct datafusion::datasource::stream::StreamTable">StreamTable</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html#method.fmt" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html#impl-TableProvider-for-StreamTable" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html#method.as_any" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html#method.schema" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html#method.constraints" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html#method.table_type" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html#method.scan" class="anchor">§</a>
...
where 'life0: 'async_trait, 'life1: 'async_trait, 'life2: 'async_trait, 'life3: 'async_trait, <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html" class="struct" title="struct datafusion::datasource::stream::StreamTable">StreamTable</a>: 'async_trait,
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html#method.insert_into" class="anchor">§</a>
...
where 'life0: 'async_trait, 'life1: 'async_trait, <a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html" class="struct" title="struct datafusion::datasource::stream::StreamTable">StreamTable</a>: 'async_trait,
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html#method.get_table_definition" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html#method.get_logical_plan" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html#method.get_column_default" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html#method.supports_filters_pushdown" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html#method.statistics" class="anchor">§</a>
...
## Auto Trait Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html#synthetic-implementations" class="anchor">§</a>

## Blanket Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/datasource/stream/struct.StreamTable.html#blanket-implementations" class="anchor">§</a>
