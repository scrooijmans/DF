# Struct StreamReader Copy item path

<a href="https://docs.rs/arrow-ipc/56.0.0/x86_64-unknown-linux-gnu/src/arrow_ipc/reader.rs.html#1330" class="src">Source</a>
...
Reads Arrow [`RecordBatch`](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/array/struct.RecordBatch.html "struct datafusion::common::arrow::array::RecordBatch")es from bytes in the [IPC Streaming Format](https://arrow.apache.org/docs/format/Columnar.html#ipc-streaming-format).

## <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#see-also" class="doc-anchor">§</a>See Also

- [`FileReader`](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.FileReader.html "struct datafusion::common::arrow::ipc::reader::FileReader") for random access.

## <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#example" class="doc-anchor">§</a>Example
...
## Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#implementations" class="anchor">§</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#impl-StreamReader%3CBufReader%3CR%3E%3E" class="anchor">§</a>

### impl\<R\> <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html" class="struct" title="struct datafusion::common::arrow::ipc::reader::StreamReader">StreamReader</a>\<<a href="https://doc.rust-lang.org/nightly/std/io/buffered/bufreader/struct.BufReader.html" class="struct" title="struct std::io::buffered::bufreader::BufReader">BufReader</a>\<R\>\>

where R: <a href="https://doc.rust-lang.org/nightly/std/io/trait.Read.html" class="trait" title="trait std::io::Read">Read</a>,

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.try_new_buffered" class="fn">try_new_buffered</a>( reader: R, projection: <a href="https://doc.rust-lang.org/nightly/core/option/enum.Option.html" class="enum" title="enum core::option::Option">Option</a>\<<a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<<a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>\>\>, ) -\> <a href="https://doc.rust-lang.org/nightly/core/result/enum.Result.html" class="enum" title="enum core::result::Result">Result</a>\<<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html" class="struct" title="struct datafusion::common::arrow::ipc::reader::StreamReader">StreamReader</a>\<<a href="https://doc.rust-lang.org/nightly/std/io/buffered/bufreader/struct.BufReader.html" class="struct" title="struct std::io::buffered::bufreader::BufReader">BufReader</a>\<R\>\>, <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/error/enum.ArrowError.html" class="enum" title="enum datafusion::common::arrow::error::ArrowError">ArrowError</a>\>

Try to create a new stream reader with the reader wrapped in a BufReader.

See [`StreamReader::try_new`](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.try_new "associated function datafusion::common::arrow::ipc::reader::StreamReader::try_new") for an unbuffered version.

<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#impl-StreamReader%3CR%3E" class="anchor">§</a>

### impl\<R\> <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html" class="struct" title="struct datafusion::common::arrow::ipc::reader::StreamReader">StreamReader</a>\<R\>

where R: <a href="https://doc.rust-lang.org/nightly/std/io/trait.Read.html" class="trait" title="trait std::io::Read">Read</a>,

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.try_new" class="fn">try_new</a>( reader: R, projection: <a href="https://doc.rust-lang.org/nightly/core/option/enum.Option.html" class="enum" title="enum core::option::Option">Option</a>\<<a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<<a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>\>\>, ) -\> <a href="https://doc.rust-lang.org/nightly/core/result/enum.Result.html" class="enum" title="enum core::result::Result">Result</a>\<<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html" class="struct" title="struct datafusion::common::arrow::ipc::reader::StreamReader">StreamReader</a>\<R\>, <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/error/enum.ArrowError.html" class="enum" title="enum datafusion::common::arrow::error::ArrowError">ArrowError</a>\>

Try to create a new stream reader.

To check if the reader is done, use [`is_finished(self)`](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.is_finished "method datafusion::common::arrow::ipc::reader::StreamReader::is_finished").

There is no internal buffering. If buffered reads are needed you likely want to use [`StreamReader::try_new_buffered`](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.try_new_buffered "associated function datafusion::common::arrow::ipc::reader::StreamReader::try_new_buffered") instead.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#errors" class="doc-anchor">§</a>Errors

An [‘Err’](https://doc.rust-lang.org/nightly/core/result/enum.Result.html#variant.Err "variant core::result::Result::Err") may be returned if the reader does not encounter a schema as the first message in the stream.

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.try_new_unbuffered" class="fn">try_new_unbuffered</a>( reader: R, projection: <a href="https://doc.rust-lang.org/nightly/core/option/enum.Option.html" class="enum" title="enum core::option::Option">Option</a>\<<a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<<a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>\>\>, ) -\> <a href="https://doc.rust-lang.org/nightly/core/result/enum.Result.html" class="enum" title="enum core::result::Result">Result</a>\<<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html" class="struct" title="struct datafusion::common::arrow::ipc::reader::StreamReader">StreamReader</a>\<R\>, <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/error/enum.ArrowError.html" class="enum" title="enum datafusion::common::arrow::error::ArrowError">ArrowError</a>\>

👎Deprecated since 53.0.0: use `try_new` instead

Deprecated, use [`StreamReader::try_new`](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.try_new "associated function datafusion::common::arrow::ipc::reader::StreamReader::try_new") instead.
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.is_finished" class="fn">is_finished</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Check if the stream is finished

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.get_ref" class="fn">get_ref</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;R</a>

Gets a reference to the underlying reader.

It is inadvisable to directly read from the underlying reader.

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.get_mut" class="fn">get_mut</a>(&mut self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;mut R</a>

Gets a mutable reference to the underlying reader.

It is inadvisable to directly read from the underlying reader.

#### pub unsafe fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.with_skip_validation" class="fn">with_skip_validation</a>( self, skip_validation: <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>, ) -\> <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html" class="struct" title="struct datafusion::common::arrow::ipc::reader::StreamReader">StreamReader</a>\<R\> <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#" class="tooltip" data-notable-ty="StreamReader&lt;R&gt;">ⓘ</a>

Specifies if validation should be skipped when reading data (defaults to `false`)

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#safety" class="doc-anchor">§</a>Safety

See [`FileDecoder::with_skip_validation`](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.FileDecoder.html#method.with_skip_validation "method datafusion::common::arrow::ipc::reader::FileDecoder::with_skip_validation")

## Trait Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#trait-implementations" class="anchor">§</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#impl-Debug-for-StreamReader%3CR%3E" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.fmt" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#impl-Iterator-for-StreamReader%3CR%3E" class="anchor">§</a>

### impl\<R\> <a href="https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html" class="trait" title="trait core::iter::traits::iterator::Iterator">Iterator</a> for <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html" class="struct" title="struct datafusion::common::arrow::ipc::reader::StreamReader">StreamReader</a>\<R\>

where R: <a href="https://doc.rust-lang.org/nightly/std/io/trait.Read.html" class="trait" title="trait std::io::Read">Read</a>,

<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#associatedtype.Item" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.next_chunk" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#187" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.size_hint" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#222-224" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.count" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#250-252" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.last" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.advance_by" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#374" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.nth" class="anchor">§</a>
...
1.28.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#424-426" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.step_by" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#613-616" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.zip" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.intersperse" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.intersperse_with" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#773-776" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.map" class="anchor">§</a>
...
1.21.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#818-821" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.for_each" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#893-896" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.filter" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#938-941" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.filter_map" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#985-987" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.enumerate" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1056-1058" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.peekable" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1121-1124" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.skip_while" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1199-1202" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.take_while" class="anchor">§</a>
...
1.57.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1287-1290" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.map_while" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1316-1318" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.skip" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1388-1390" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.take" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1435-1438" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.scan" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1473-1477" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.flat_map" class="anchor">§</a>
...
1.29.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1557-1560" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.flatten" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.map_windows" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1775-1777" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.fuse" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1859-1862" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.inspect" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#1896-1898" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.by_ref" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#2015-2017" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.collect" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.try_collect" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.collect_into" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#2206-2210" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.partition" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.partition_in_place" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.is_partitioned" class="anchor">§</a>
...
1.27.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#2419-2423" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.try_fold" class="anchor">§</a>
...
1.27.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#2477-2481" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.try_for_each" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#2596-2599" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.fold" class="anchor">§</a>
...
1.51.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#2633-2636" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.reduce" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.try_reduce" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#2762-2765" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.all" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#2815-2818" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.any" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#2877-2880" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.find" class="anchor">§</a>
...
1.30.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#2908-2911" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.find_map" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.try_find" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3049-3052" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.position" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3114-3117" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.rposition" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3163-3166" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.max" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3199-3202" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.min" class="anchor">§</a>
...
1.6.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3221-3224" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.max_by_key" class="anchor">§</a>
...
1.15.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3254-3257" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.max_by" class="anchor">§</a>
...
1.6.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3281-3284" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.min_by_key" class="anchor">§</a>
...
1.15.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3314-3317" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.min_by" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3351-3353" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.rev" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3387-3391" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.unzip" class="anchor">§</a>
...
1.36.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3418-3421" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.copied" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3466-3469" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.cloned" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3497-3499" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.cycle" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.array_chunks" class="anchor">§</a>
...
1.11.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3576-3579" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.sum" class="anchor">§</a>
...
1.11.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3608-3611" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.product" class="anchor">§</a>
...
1.5.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3629-3633" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.cmp" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.cmp_by" class="anchor">§</a>
...
1.5.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3712-3716" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.partial_cmp" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.partial_cmp_by" class="anchor">§</a>
...
1.5.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3781-3785" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.eq" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.eq_by" class="anchor">§</a>
...
1.5.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3833-3837" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.ne" class="anchor">§</a>
...
1.5.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3854-3858" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.lt" class="anchor">§</a>
...
1.5.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3875-3879" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.le" class="anchor">§</a>
...
1.5.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3896-3900" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.gt" class="anchor">§</a>
...
1.5.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3917-3921" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.ge" class="anchor">§</a>
...
1.82.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3946-3949" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.is_sorted" class="anchor">§</a>
...
1.82.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#3972-3975" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.is_sorted_by" class="anchor">§</a>
...
1.82.0 · <a href="https://doc.rust-lang.org/nightly/src/core/iter/traits/iterator.rs.html#4016-4020" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.is_sorted_by_key" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#impl-RecordBatchReader-for-StreamReader%3CR%3E" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#method.schema-1" class="anchor">§</a>

#### fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/array/trait.RecordBatchReader.html#tymethod.schema" class="fn">schema</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/datatypes/struct.Schema.html" class="struct" title="struct datafusion::common::arrow::datatypes::Schema">Schema</a>\>

Returns the schema of this `RecordBatchReader`. [Read more](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/array/trait.RecordBatchReader.html#tymethod.schema)

## Auto Trait Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#synthetic-implementations" class="anchor">§</a>

## Blanket Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/ipc/reader/struct.StreamReader.html#blanket-implementations" class="anchor">§</a>
