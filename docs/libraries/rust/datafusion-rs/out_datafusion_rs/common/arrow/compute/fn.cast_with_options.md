...
<a href="https://docs.rs/arrow-cast/56.0.0/x86_64-unknown-linux-gnu/src/arrow_cast/cast/mod.rs.html#712-716" class="src">Source</a>
...
Accepts [`CastOptions`](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/compute/struct.CastOptions.html "struct datafusion::common::arrow::compute::CastOptions") to specify cast behavior. See also [`cast()`](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/compute/fn.cast.html "fn datafusion::common::arrow::compute::cast").

## <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/compute/fn.cast_with_options.html#behavior" class="doc-anchor">§</a>Behavior
...
## <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/compute/fn.cast_with_options.html#durations-and-intervals" class="doc-anchor">§</a>Durations and Intervals

Casting integer types directly to interval types such as [`IntervalMonthDayNano`](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/datatypes/struct.IntervalMonthDayNano.html "struct datafusion::common::arrow::datatypes::IntervalMonthDayNano") is not supported because the meaning of the integer is ambiguous. For example, the integer could represent either nanoseconds or months.
...
## <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/compute/fn.cast_with_options.html#timestamps-and-timezones" class="doc-anchor">§</a>Timestamps and Timezones

Timestamps are stored with an optional timezone in Arrow.

### <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/compute/fn.cast_with_options.html#casting-timestamps-to-a-timestamp-without-timezone--utc" class="doc-anchor">§</a>Casting timestamps to a timestamp without timezone / UTC
...
### <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/compute/fn.cast_with_options.html#casting-timestamps-to-a-timestamp-with-timezone" class="doc-anchor">§</a>Casting timestamps to a timestamp with timezone
...
## <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/compute/fn.cast_with_options.html#casting-timestamps-without-timezone-to-timestamps-with-timezone" class="doc-anchor">§</a>Casting timestamps without timezone to timestamps with timezone
