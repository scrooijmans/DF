...
<a href="https://docs.rs/arrow-string/56.0.0/x86_64-unknown-linux-gnu/src/arrow_string/regexp.rs.html#69-77" class="src">Source</a>
...
This is equivalent to the SQL `array ~ regex_array`, supporting [`StringArray`](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/array/type.StringArray.html "type datafusion::common::arrow::array::StringArray") / [`LargeStringArray`](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/array/type.LargeStringArray.html "type datafusion::common::arrow::array::LargeStringArray") / [`StringViewArray`](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/array/type.StringViewArray.html "type datafusion::common::arrow::array::StringViewArray").

If `regex_array` element has an empty value, the corresponding result value is always true.

`flags_array` are optional [`StringArray`](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/array/type.StringArray.html "type datafusion::common::arrow::array::StringArray") / [`LargeStringArray`](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/array/type.LargeStringArray.html "type datafusion::common::arrow::array::LargeStringArray") / [`StringViewArray`](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/array/type.StringViewArray.html "type datafusion::common::arrow::array::StringViewArray") flag, which allow special search modes, such as case-insensitive and multi-line mode. See the documentation [here](https://docs.rs/regex/1.5.4/regex/#grouping-and-flags) for more information.

## <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/compute/fn.regexp_is_match.html#see-also" class="doc-anchor">§</a>See Also

- [`regexp_is_match_scalar`](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/compute/fn.regexp_is_match_scalar.html "fn datafusion::common::arrow::compute::regexp_is_match_scalar") for matching a single regular expression against an array of strings
- [`regexp_match`](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/compute/fn.regexp_match.html "fn datafusion::common::arrow::compute::regexp_match") for extracting groups from a string array based on a regular expression

## <a href="https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/compute/fn.regexp_is_match.html#example" class="doc-anchor">§</a>Example
