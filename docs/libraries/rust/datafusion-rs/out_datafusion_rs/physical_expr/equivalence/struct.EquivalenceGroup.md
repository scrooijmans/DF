# Struct EquivalenceGroup Copy item path

<a href="https://docs.rs/datafusion-physical-expr/50.2.0/x86_64-unknown-linux-gnu/src/datafusion_physical_expr/equivalence/class.rs.html#304" class="src">Source</a>
...
## Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#implementations" class="anchor">§</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#impl-EquivalenceGroup" class="anchor">§</a>

### impl <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html" class="struct" title="struct datafusion::physical_expr::equivalence::EquivalenceGroup">EquivalenceGroup</a>

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.new" class="fn">new</a>( classes: impl <a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html" class="trait" title="trait core::iter::traits::collect::IntoIterator">IntoIterator</a>\<Item = <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceClass.html" class="struct" title="struct datafusion::physical_expr::equivalence::EquivalenceClass">EquivalenceClass</a>\>, ) -\> <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html" class="struct" title="struct datafusion::physical_expr::equivalence::EquivalenceGroup">EquivalenceGroup</a>

Creates an equivalence group from the given equivalence classes.

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.add_constant" class="fn">add_constant</a>(&mut self, const_expr: <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.ConstExpr.html" class="struct" title="struct datafusion::physical_expr::ConstExpr">ConstExpr</a>)

Adds `expr` as a constant expression to this equivalence group.

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.clear_per_partition_constants" class="fn">clear_per_partition_constants</a>(&mut self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Removes constant expressions that may change across partitions. This method should be used when merging data from different partitions. Returns whether any change was made to the equivalence group.

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.add_equal_conditions" class="fn">add_equal_conditions</a>( &mut self, left: <a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<dyn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/trait.PhysicalExpr.html" class="trait" title="trait datafusion::physical_expr::PhysicalExpr">PhysicalExpr</a>\>, right: <a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<dyn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/trait.PhysicalExpr.html" class="trait" title="trait datafusion::physical_expr::PhysicalExpr">PhysicalExpr</a>\>, ) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Adds the equality `left` = `right` to this equivalence group. New equality conditions often arise after steps like `Filter(a = b)`, `Alias(a, a as b)` etc. Returns whether the given equality defines a new equivalence class.
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.normalize_sort_exprs" class="fn">normalize_sort_exprs</a>\<'a\>( &'a self, sort_exprs: impl <a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html" class="trait" title="trait core::iter::traits::collect::IntoIterator">IntoIterator</a>\<Item = <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.PhysicalSortExpr.html" class="struct" title="struct datafusion::physical_expr::PhysicalSortExpr">PhysicalSortExpr</a>\> + 'a, ) -\> impl <a href="https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html" class="trait" title="trait core::iter::traits::iterator::Iterator">Iterator</a>\<Item = <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.PhysicalSortExpr.html" class="struct" title="struct datafusion::physical_expr::PhysicalSortExpr">PhysicalSortExpr</a>\> + 'a

Normalizes the given sort expressions (i.e. `sort_exprs`) by:

- Replacing sections that belong to some equivalence class in the with the first entry in the matching equivalence class.
- Removing expressions that have a constant value.

If columns `a` and `b` are known to be equal, `d` is known to be a constant, and `sort_exprs` is `[b ASC, d DESC, c ASC, a ASC]`, this function would return `[a ASC, c ASC, a ASC]`.

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.normalize_sort_requirement" class="fn">normalize_sort_requirement</a>( &self, sort_requirement: <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.PhysicalSortRequirement.html" class="struct" title="struct datafusion::physical_expr::PhysicalSortRequirement">PhysicalSortRequirement</a>, ) -\> <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.PhysicalSortRequirement.html" class="struct" title="struct datafusion::physical_expr::PhysicalSortRequirement">PhysicalSortRequirement</a>
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.normalize_sort_requirements" class="fn">normalize_sort_requirements</a>\<'a\>( &'a self, sort_reqs: impl <a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html" class="trait" title="trait core::iter::traits::collect::IntoIterator">IntoIterator</a>\<Item = <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.PhysicalSortRequirement.html" class="struct" title="struct datafusion::physical_expr::PhysicalSortRequirement">PhysicalSortRequirement</a>\> + 'a, ) -\> impl <a href="https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html" class="trait" title="trait core::iter::traits::iterator::Iterator">Iterator</a>\<Item = <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.PhysicalSortRequirement.html" class="struct" title="struct datafusion::physical_expr::PhysicalSortRequirement">PhysicalSortRequirement</a>\> + 'a
...
If columns `a` and `b` are known to be equal, `d` is known to be a constant, and `sort_reqs` is `[b ASC, d DESC, c ASC, a ASC]`, this function would return `[a ASC, c ASC, a ASC]`.

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.project_expr" class="fn">project_expr</a>( &self, mapping: &<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.ProjectionMapping.html" class="struct" title="struct datafusion::physical_expr::equivalence::ProjectionMapping">ProjectionMapping</a>, expr: &<a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<dyn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/trait.PhysicalExpr.html" class="trait" title="trait datafusion::physical_expr::PhysicalExpr">PhysicalExpr</a>\>, ) -\> <a href="https://doc.rust-lang.org/nightly/core/option/enum.Option.html" class="enum" title="enum core::option::Option">Option</a>\<<a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<dyn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/trait.PhysicalExpr.html" class="trait" title="trait datafusion::physical_expr::PhysicalExpr">PhysicalExpr</a>\>\>
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.project_expressions" class="fn">project_expressions</a>\<'a\>( &'a self, mapping: &'a <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.ProjectionMapping.html" class="struct" title="struct datafusion::physical_expr::equivalence::ProjectionMapping">ProjectionMapping</a>, expressions: impl <a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html" class="trait" title="trait core::iter::traits::collect::IntoIterator">IntoIterator</a>\<Item = &'a <a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<dyn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/trait.PhysicalExpr.html" class="trait" title="trait datafusion::physical_expr::PhysicalExpr">PhysicalExpr</a>\>\> + 'a, ) -\> impl <a href="https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html" class="trait" title="trait core::iter::traits::iterator::Iterator">Iterator</a>\<Item = <a href="https://doc.rust-lang.org/nightly/core/option/enum.Option.html" class="enum" title="enum core::option::Option">Option</a>\<<a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<dyn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/trait.PhysicalExpr.html" class="trait" title="trait datafusion::physical_expr::PhysicalExpr">PhysicalExpr</a>\>\>\> + 'a

Projects `expressions` according to the given projection mapping. This function is similar to [`Self::project_expr`](https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.project_expr "method datafusion::physical_expr::equivalence::EquivalenceGroup::project_expr"), but projects multiple expressions at once more efficiently than calling `project_expr` for each expression.

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.project" class="fn">project</a>(&self, mapping: &<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.ProjectionMapping.html" class="struct" title="struct datafusion::physical_expr::equivalence::ProjectionMapping">ProjectionMapping</a>) -\> <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html" class="struct" title="struct datafusion::physical_expr::equivalence::EquivalenceGroup">EquivalenceGroup</a>
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.get_equivalence_class" class="fn">get_equivalence_class</a>( &self, expr: &<a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<dyn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/trait.PhysicalExpr.html" class="trait" title="trait datafusion::physical_expr::PhysicalExpr">PhysicalExpr</a>\>, ) -\> <a href="https://doc.rust-lang.org/nightly/core/option/enum.Option.html" class="enum" title="enum core::option::Option">Option</a>\<&<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceClass.html" class="struct" title="struct datafusion::physical_expr::equivalence::EquivalenceClass">EquivalenceClass</a>\>

Returns the equivalence class containing `expr`. If no equivalence class contains `expr`, returns `None`.

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.join" class="fn">join</a>( &self, right_equivalences: &<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html" class="struct" title="struct datafusion::physical_expr::equivalence::EquivalenceGroup">EquivalenceGroup</a>, join_type: &<a href="https://docs.rs/datafusion/50.2.0/datafusion/prelude/enum.JoinType.html" class="enum" title="enum datafusion::prelude::JoinType">JoinType</a>, left_size: <a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>, on: &\[(<a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<dyn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/trait.PhysicalExpr.html" class="trait" title="trait datafusion::physical_expr::PhysicalExpr">PhysicalExpr</a>\>, <a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<dyn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/trait.PhysicalExpr.html" class="trait" title="trait datafusion::physical_expr::PhysicalExpr">PhysicalExpr</a>\>)\], ) -\> <a href="https://doc.rust-lang.org/nightly/core/result/enum.Result.html" class="enum" title="enum core::result::Result">Result</a>\<<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html" class="struct" title="struct datafusion::physical_expr::equivalence::EquivalenceGroup">EquivalenceGroup</a>, <a href="https://docs.rs/datafusion/50.2.0/datafusion/error/enum.DataFusionError.html" class="enum" title="enum datafusion::error::DataFusionError">DataFusionError</a>\>

Combine equivalence groups of the given join children.

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.exprs_equal" class="fn">exprs_equal</a>( &self, left: &<a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<dyn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/trait.PhysicalExpr.html" class="trait" title="trait datafusion::physical_expr::PhysicalExpr">PhysicalExpr</a>\>, right: &<a href="https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html" class="struct" title="struct alloc::sync::Arc">Arc</a>\<dyn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/trait.PhysicalExpr.html" class="trait" title="trait datafusion::physical_expr::PhysicalExpr">PhysicalExpr</a>\>, ) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Checks if two expressions are equal directly or through equivalence classes. For complex expressions (e.g. `a + b`), checks that the expression trees are structurally identical and their leaf nodes are equivalent either directly or through equivalence classes.

## Methods from <a href="https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html" class="trait" title="trait core::ops::deref::Deref">Deref</a>\<Target = \[<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceClass.html" class="struct" title="struct datafusion::physical_expr::equivalence::EquivalenceClass">EquivalenceClass</a>\]\><a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#deref-methods-%5BEquivalenceClass%5D" class="anchor">§</a>

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/slice/mod.rs.html#114" class="src">Source</a>

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.len" class="fn">len</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>

Returns the number of elements in the slice.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.is_empty" class="fn">is_empty</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Returns `true` if the slice has a length of 0.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-1" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-2" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-3" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-4" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-5" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-6" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-7" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-8" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-9" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-10" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#safety" class="doc-anchor">§</a>Safety
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-11" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.as_ptr" class="fn">as_ptr</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.pointer.html" class="primitive">*const T</a>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-12" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.iter" class="fn">iter</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.Iter.html" class="struct" title="struct core::slice::iter::Iter">Iter</a>\<'\_, T\>

Returns an iterator over the slice.

The iterator yields all items from start to end.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-13" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#panics" class="doc-anchor">§</a>Panics

Panics if `size` is zero.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-14" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#panics-1" class="doc-anchor">§</a>Panics

Panics if `chunk_size` is zero.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-15" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#panics-2" class="doc-anchor">§</a>Panics

Panics if `chunk_size` is zero.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-16" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#safety-1" class="doc-anchor">§</a>Safety
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-17" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#panics-3" class="doc-anchor">§</a>Panics
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-18" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#panics-4" class="doc-anchor">§</a>Panics

Panics if `N` is zero.

Note that this check is against a const generic parameter, not a runtime value, and thus a particular monomorphization will either always panic or it will never panic.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-19" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#panics-5" class="doc-anchor">§</a>Panics

Panics if `N` is zero. This check will most probably get changed to a compile time error before this method gets stabilized.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-20" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#panics-6" class="doc-anchor">§</a>Panics

Panics if `chunk_size` is zero.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-21" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#panics-7" class="doc-anchor">§</a>Panics

Panics if `chunk_size` is zero.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-22" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.chunk_by" class="fn">chunk_by</a>\<F\>(&self, pred: F) -\> <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.ChunkBy.html" class="struct" title="struct core::slice::iter::ChunkBy">ChunkBy</a>\<'\_, T, F\>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-23" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#panics-8" class="doc-anchor">§</a>Panics
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-24" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#safety-2" class="doc-anchor">§</a>Safety
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-25" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-26" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.split" class="fn">split</a>\<F\>(&self, pred: F) -\> <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.Split.html" class="struct" title="struct core::slice::iter::Split">Split</a>\<'\_, T, F\>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-27" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-28" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.rsplit" class="fn">rsplit</a>\<F\>(&self, pred: F) -\> <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.RSplit.html" class="struct" title="struct core::slice::iter::RSplit">RSplit</a>\<'\_, T, F\>

where F: <a href="https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html" class="trait" title="trait core::ops::function::FnMut">FnMut</a>(<a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;T</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>,

Returns an iterator over subslices separated by elements that match `pred`, starting at the end of the slice and working backwards. The matched element is not contained in the subslices.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-29" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-30" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-31" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-32" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-33" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-34" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-35" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-36" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-37" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-38" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-39" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-40" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-41" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-42" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-43" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#safety-3" class="doc-anchor">§</a>Safety

This method is essentially a `transmute` with respect to the elements in the returned middle slice, so all the usual caveats pertaining to `transmute::<T, U>` also apply here.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-44" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#panics-9" class="doc-anchor">§</a>Panics

This will panic if the size of the SIMD type is different from `LANES` times that of the scalar.

At the time of writing, the trait restrictions on `Simd<T, LANES>` keeps that from ever happening, as only power-of-two numbers of lanes are supported. It’s possible that, in the future, those restrictions might be lifted in a way that would make it possible to see panics from this method for something like `LANES == 3`.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-45" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.is_sorted" class="fn">is_sorted</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-46" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.is_sorted_by" class="fn">is_sorted_by</a>\<'a, F\>(&'a self, compare: F) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-47" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.is_sorted_by_key" class="fn">is_sorted_by_key</a>\<'a, F, K\>(&'a self, f: F) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-48" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.partition_point" class="fn">partition_point</a>\<P\>(&self, pred: P) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-49" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#panics-10" class="doc-anchor">§</a>Panics

Panics if `T` is zero-sized.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-50" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#panics-11" class="doc-anchor">§</a>Panics

Panics if `T` is zero-sized.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-51" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.to_vec" class="fn">to_vec</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<T\>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-52" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.to_vec_in" class="fn">to_vec_in</a>\<A\>(&self, alloc: A) -\> <a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<T, A\>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-53" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#panics-12" class="doc-anchor">§</a>Panics

This function will panic if the capacity would overflow.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-54" class="doc-anchor">§</a>Examples
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#" class="tooltip" title="This example panics">ⓘ</a>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-55" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.join-1" class="fn">join</a>\<Separator\>( &self, sep: Separator, ) -\> \<<a href="https://doc.rust-lang.org/nightly/std/primitive.slice.html" class="primitive">[T]</a> as <a href="https://doc.rust-lang.org/nightly/alloc/slice/trait.Join.html" class="trait" title="trait alloc::slice::Join">Join</a>\<Separator\>\>::<a href="https://doc.rust-lang.org/nightly/alloc/slice/trait.Join.html#associatedtype.Output" class="associatedtype" title="type alloc::slice::Join::Output">Output</a> <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#" class="tooltip" data-notable-ty="&lt;[T] as Join&lt;Separator&gt;&gt;::Output">ⓘ</a>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-56" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#examples-57" class="doc-anchor">§</a>Examples
...
## Trait Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#trait-implementations" class="anchor">§</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#impl-Clone-for-EquivalenceGroup" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html" class="trait" title="trait core::clone::Clone">Clone</a> for <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html" class="struct" title="struct datafusion::physical_expr::equivalence::EquivalenceGroup">EquivalenceGroup</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.clone" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone" class="fn">clone</a>(&self) -\> <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html" class="struct" title="struct datafusion::physical_expr::equivalence::EquivalenceGroup">EquivalenceGroup</a>

Returns a duplicate of the value. [Read more](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/clone.rs.html#245-247" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.clone_from" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#method.clone_from" class="fn">clone_from</a>(&mut self, source: &Self)

Performs copy-assignment from `source`. [Read more](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#method.clone_from)

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#impl-Debug-for-EquivalenceGroup" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html" class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html" class="struct" title="struct datafusion::physical_expr::equivalence::EquivalenceGroup">EquivalenceGroup</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.fmt" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#impl-Default-for-EquivalenceGroup" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/default/trait.Default.html" class="trait" title="trait core::default::Default">Default</a> for <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html" class="struct" title="struct datafusion::physical_expr::equivalence::EquivalenceGroup">EquivalenceGroup</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.default" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default" class="fn">default</a>() -\> <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html" class="struct" title="struct datafusion::physical_expr::equivalence::EquivalenceGroup">EquivalenceGroup</a>

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#impl-Deref-for-EquivalenceGroup" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html" class="trait" title="trait core::ops::deref::Deref">Deref</a> for <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html" class="struct" title="struct datafusion::physical_expr::equivalence::EquivalenceGroup">EquivalenceGroup</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#associatedtype.Target" class="anchor">§</a>

#### type <a href="https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target" class="associatedtype">Target</a> = \[<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceClass.html" class="struct" title="struct datafusion::physical_expr::equivalence::EquivalenceClass">EquivalenceClass</a>\]

The resulting type after dereferencing.

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.deref" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#impl-Display-for-EquivalenceGroup" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.fmt-1" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html#tymethod.fmt" class="fn">fmt</a>(&self, f: &mut <a href="https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html" class="struct" title="struct core::fmt::Formatter">Formatter</a>\<'\_\>) -\> <a href="https://doc.rust-lang.org/nightly/core/result/enum.Result.html" class="enum" title="enum core::result::Result">Result</a>\<<a href="https://doc.rust-lang.org/nightly/std/primitive.unit.html" class="primitive">()</a>, <a href="https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html" class="struct" title="struct core::fmt::Error">Error</a>\>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html#tymethod.fmt)

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#impl-From%3CVec%3CEquivalenceClass%3E%3E-for-EquivalenceGroup" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html" class="trait" title="trait core::convert::From">From</a>\<<a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceClass.html" class="struct" title="struct datafusion::physical_expr::equivalence::EquivalenceClass">EquivalenceClass</a>\>\> for <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html" class="struct" title="struct datafusion::physical_expr::equivalence::EquivalenceGroup">EquivalenceGroup</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.from" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from" class="fn">from</a>(classes: <a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceClass.html" class="struct" title="struct datafusion::physical_expr::equivalence::EquivalenceClass">EquivalenceClass</a>\>) -\> <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html" class="struct" title="struct datafusion::physical_expr::equivalence::EquivalenceGroup">EquivalenceGroup</a>

Converts to this type from the input type.

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#impl-IntoIterator-for-EquivalenceGroup" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html" class="trait" title="trait core::iter::traits::collect::IntoIterator">IntoIterator</a> for <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html" class="struct" title="struct datafusion::physical_expr::equivalence::EquivalenceGroup">EquivalenceGroup</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#associatedtype.Item" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#associatedtype.IntoIter" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#method.into_iter" class="anchor">§</a>
...
## Auto Trait Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#synthetic-implementations" class="anchor">§</a>

## Blanket Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/equivalence/struct.EquivalenceGroup.html#blanket-implementations" class="anchor">§</a>
