# Struct LexRequirement Copy item path

<a href="https://docs.rs/datafusion-physical-expr-common/50.2.0/x86_64-unknown-linux-gnu/src/datafusion_physical_expr_common/sort_expr.rs.html#516" class="src">Source</a>

``` rust
pub struct LexRequirement { /* private fields */ }
```
...
For example, a `vec![a Some(ASC), b None]` represents a lexicographical requirement that firsts imposes an ordering by column `a` in ascending order, then by column `b` in *any* (ascending or descending) order. The ordering is non-degenerate, meaning it contains at least one element, and it is duplicate-free, meaning it does not contain multiple entries for the same column.

Note that a `LexRequirement` need not enforce the uniqueness of its sort expressions after construction like a `LexOrdering` does, because it provides no mutation methods. If such methods become necessary, we will need to enforce uniqueness like the latter object.

## Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#implementations" class="anchor">§</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#impl-LexRequirement" class="anchor">§</a>

### impl <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html" class="struct" title="struct datafusion::physical_expr::LexRequirement">LexRequirement</a>

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.new" class="fn">new</a>( reqs: impl <a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html" class="trait" title="trait core::iter::traits::collect::IntoIterator">IntoIterator</a>\<Item = <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.PhysicalSortRequirement.html" class="struct" title="struct datafusion::physical_expr::PhysicalSortRequirement">PhysicalSortRequirement</a>\>, ) -\> <a href="https://doc.rust-lang.org/nightly/core/option/enum.Option.html" class="enum" title="enum core::option::Option">Option</a>\<<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html" class="struct" title="struct datafusion::physical_expr::LexRequirement">LexRequirement</a>\>

Creates a new [`LexRequirement`](https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html "struct datafusion::physical_expr::LexRequirement") from the given vector of sort expressions. If the vector is empty, returns `None`.
...
Returns the leading `PhysicalSortRequirement` of the `LexRequirement`. Note that this function does not return an `Option`, as a `LexRequirement` is always non-degenerate (i.e. it contains at least one element).

## Methods from <a href="https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html" class="trait" title="trait core::ops::deref::Deref">Deref</a>\<Target = \[<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.PhysicalSortRequirement.html" class="struct" title="struct datafusion::physical_expr::PhysicalSortRequirement">PhysicalSortRequirement</a>\]\><a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#deref-methods-%5BPhysicalSortRequirement%5D" class="anchor">§</a>

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/slice/mod.rs.html#114" class="src">Source</a>

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.len" class="fn">len</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>

Returns the number of elements in the slice.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.is_empty" class="fn">is_empty</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Returns `true` if the slice has a length of 0.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-1" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-2" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-3" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-4" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-5" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-6" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-7" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-8" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-9" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-10" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#safety" class="doc-anchor">§</a>Safety
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-11" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.as_ptr" class="fn">as_ptr</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.pointer.html" class="primitive">*const T</a>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-12" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.iter" class="fn">iter</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.Iter.html" class="struct" title="struct core::slice::iter::Iter">Iter</a>\<'\_, T\>

Returns an iterator over the slice.

The iterator yields all items from start to end.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-13" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#panics" class="doc-anchor">§</a>Panics

Panics if `size` is zero.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-14" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#panics-1" class="doc-anchor">§</a>Panics

Panics if `chunk_size` is zero.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-15" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#panics-2" class="doc-anchor">§</a>Panics

Panics if `chunk_size` is zero.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-16" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#safety-1" class="doc-anchor">§</a>Safety
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-17" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#panics-3" class="doc-anchor">§</a>Panics
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-18" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#panics-4" class="doc-anchor">§</a>Panics

Panics if `N` is zero.

Note that this check is against a const generic parameter, not a runtime value, and thus a particular monomorphization will either always panic or it will never panic.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-19" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#panics-5" class="doc-anchor">§</a>Panics

Panics if `N` is zero. This check will most probably get changed to a compile time error before this method gets stabilized.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-20" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#panics-6" class="doc-anchor">§</a>Panics

Panics if `chunk_size` is zero.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-21" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#panics-7" class="doc-anchor">§</a>Panics

Panics if `chunk_size` is zero.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-22" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.chunk_by" class="fn">chunk_by</a>\<F\>(&self, pred: F) -\> <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.ChunkBy.html" class="struct" title="struct core::slice::iter::ChunkBy">ChunkBy</a>\<'\_, T, F\>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-23" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#panics-8" class="doc-anchor">§</a>Panics
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-24" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#safety-2" class="doc-anchor">§</a>Safety
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-25" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-26" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.split" class="fn">split</a>\<F\>(&self, pred: F) -\> <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.Split.html" class="struct" title="struct core::slice::iter::Split">Split</a>\<'\_, T, F\>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-27" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-28" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.rsplit" class="fn">rsplit</a>\<F\>(&self, pred: F) -\> <a href="https://doc.rust-lang.org/nightly/core/slice/iter/struct.RSplit.html" class="struct" title="struct core::slice::iter::RSplit">RSplit</a>\<'\_, T, F\>

where F: <a href="https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html" class="trait" title="trait core::ops::function::FnMut">FnMut</a>(<a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;T</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>,

Returns an iterator over subslices separated by elements that match `pred`, starting at the end of the slice and working backwards. The matched element is not contained in the subslices.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-29" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-30" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-31" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-32" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-33" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-34" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-35" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-36" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-37" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-38" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-39" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-40" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-41" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-42" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-43" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#safety-3" class="doc-anchor">§</a>Safety

This method is essentially a `transmute` with respect to the elements in the returned middle slice, so all the usual caveats pertaining to `transmute::<T, U>` also apply here.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-44" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#panics-9" class="doc-anchor">§</a>Panics

This will panic if the size of the SIMD type is different from `LANES` times that of the scalar.

At the time of writing, the trait restrictions on `Simd<T, LANES>` keeps that from ever happening, as only power-of-two numbers of lanes are supported. It’s possible that, in the future, those restrictions might be lifted in a way that would make it possible to see panics from this method for something like `LANES == 3`.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-45" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.is_sorted" class="fn">is_sorted</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-46" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.is_sorted_by" class="fn">is_sorted_by</a>\<'a, F\>(&'a self, compare: F) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-47" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.is_sorted_by_key" class="fn">is_sorted_by_key</a>\<'a, F, K\>(&'a self, f: F) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-48" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.partition_point" class="fn">partition_point</a>\<P\>(&self, pred: P) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-49" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#panics-10" class="doc-anchor">§</a>Panics

Panics if `T` is zero-sized.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-50" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#panics-11" class="doc-anchor">§</a>Panics

Panics if `T` is zero-sized.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-51" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.to_vec" class="fn">to_vec</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<T\>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-52" class="doc-anchor">§</a>Examples
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.to_vec_in" class="fn">to_vec_in</a>\<A\>(&self, alloc: A) -\> <a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<T, A\>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-53" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#panics-12" class="doc-anchor">§</a>Panics

This function will panic if the capacity would overflow.

##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-54" class="doc-anchor">§</a>Examples
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#" class="tooltip" title="This example panics">ⓘ</a>
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-55" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-56" class="doc-anchor">§</a>Examples
...
##### <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#examples-57" class="doc-anchor">§</a>Examples
...
## Trait Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#trait-implementations" class="anchor">§</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#impl-Clone-for-LexRequirement" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html" class="trait" title="trait core::clone::Clone">Clone</a> for <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html" class="struct" title="struct datafusion::physical_expr::LexRequirement">LexRequirement</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.clone" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone" class="fn">clone</a>(&self) -\> <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html" class="struct" title="struct datafusion::physical_expr::LexRequirement">LexRequirement</a>

Returns a duplicate of the value. [Read more](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/clone.rs.html#245-247" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.clone_from" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#method.clone_from" class="fn">clone_from</a>(&mut self, source: &Self)

Performs copy-assignment from `source`. [Read more](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#method.clone_from)

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#impl-Debug-for-LexRequirement" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html" class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html" class="struct" title="struct datafusion::physical_expr::LexRequirement">LexRequirement</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.fmt" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#impl-Deref-for-LexRequirement" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html" class="trait" title="trait core::ops::deref::Deref">Deref</a> for <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html" class="struct" title="struct datafusion::physical_expr::LexRequirement">LexRequirement</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#associatedtype.Target" class="anchor">§</a>

#### type <a href="https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target" class="associatedtype">Target</a> = \[<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.PhysicalSortRequirement.html" class="struct" title="struct datafusion::physical_expr::PhysicalSortRequirement">PhysicalSortRequirement</a>\]

The resulting type after dereferencing.

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.deref" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref" class="fn">deref</a>(&self) -\> &\<<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html" class="struct" title="struct datafusion::physical_expr::LexRequirement">LexRequirement</a> as <a href="https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html" class="trait" title="trait core::ops::deref::Deref">Deref</a>\>::<a href="https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target" class="associatedtype" title="type core::ops::deref::Deref::Target">Target</a>

Dereferences the value.

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#impl-From%3C%5BPhysicalSortRequirement;+N%5D%3E-for-LexRequirement" class="anchor">§</a>

### impl\<const N: <a href="https://doc.rust-lang.org/nightly/std/primitive.usize.html" class="primitive">usize</a>\> <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html" class="trait" title="trait core::convert::From">From</a>\<\[<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.PhysicalSortRequirement.html" class="struct" title="struct datafusion::physical_expr::PhysicalSortRequirement">PhysicalSortRequirement</a>; <a href="https://doc.rust-lang.org/nightly/std/primitive.array.html" class="primitive">N</a>\]\> for <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html" class="struct" title="struct datafusion::physical_expr::LexRequirement">LexRequirement</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.from" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from" class="fn">from</a>(value: \[<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.PhysicalSortRequirement.html" class="struct" title="struct datafusion::physical_expr::PhysicalSortRequirement">PhysicalSortRequirement</a>; <a href="https://doc.rust-lang.org/nightly/std/primitive.array.html" class="primitive">N</a>\]) -\> <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html" class="struct" title="struct datafusion::physical_expr::LexRequirement">LexRequirement</a>

Converts to this type from the input type.

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#impl-From%3CLexOrdering%3E-for-LexRequirement" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.from-2" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#impl-From%3CLexRequirement%3E-for-LexOrdering" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.from-3" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#impl-From%3CLexRequirement%3E-for-OrderingRequirements" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.from-4" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from" class="fn">from</a>(requirement: <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html" class="struct" title="struct datafusion::physical_expr::LexRequirement">LexRequirement</a>) -\> <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/enum.OrderingRequirements.html" class="enum" title="enum datafusion::physical_expr::OrderingRequirements">OrderingRequirements</a>

Converts to this type from the input type.

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#impl-From%3CLexRequirement%3E-for-Vec%3CPhysicalSortRequirement%3E" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html" class="trait" title="trait core::convert::From">From</a>\<<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html" class="struct" title="struct datafusion::physical_expr::LexRequirement">LexRequirement</a>\> for <a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.PhysicalSortRequirement.html" class="struct" title="struct datafusion::physical_expr::PhysicalSortRequirement">PhysicalSortRequirement</a>\>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.from-1" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from" class="fn">from</a>(requirement: <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html" class="struct" title="struct datafusion::physical_expr::LexRequirement">LexRequirement</a>) -\> <a href="https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html" class="struct" title="struct alloc::vec::Vec">Vec</a>\<<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.PhysicalSortRequirement.html" class="struct" title="struct datafusion::physical_expr::PhysicalSortRequirement">PhysicalSortRequirement</a>\>

Converts to this type from the input type.

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#impl-IntoIterator-for-%26LexRequirement" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#associatedtype.Item-1" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#associatedtype.IntoIter-1" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.into_iter-1" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter" class="fn">into_iter</a>(self) -\> \<&'a <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html" class="struct" title="struct datafusion::physical_expr::LexRequirement">LexRequirement</a> as <a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html" class="trait" title="trait core::iter::traits::collect::IntoIterator">IntoIterator</a>\>::<a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter" class="associatedtype" title="type core::iter::traits::collect::IntoIterator::IntoIter">IntoIter</a>

Creates an iterator from a value. [Read more](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#impl-IntoIterator-for-LexRequirement" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#associatedtype.Item" class="anchor">§</a>

#### type <a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.Item" class="associatedtype">Item</a> = <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.PhysicalSortRequirement.html" class="struct" title="struct datafusion::physical_expr::PhysicalSortRequirement">PhysicalSortRequirement</a>

The type of the elements being iterated over.

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#associatedtype.IntoIter" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.into_iter" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter" class="fn">into_iter</a>(self) -\> \<<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html" class="struct" title="struct datafusion::physical_expr::LexRequirement">LexRequirement</a> as <a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html" class="trait" title="trait core::iter::traits::collect::IntoIterator">IntoIterator</a>\>::<a href="https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter" class="associatedtype" title="type core::iter::traits::collect::IntoIterator::IntoIter">IntoIter</a>

Creates an iterator from a value. [Read more](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#impl-PartialEq-for-LexRequirement" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html" class="trait" title="trait core::cmp::PartialEq">PartialEq</a> for <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html" class="struct" title="struct datafusion::physical_expr::LexRequirement">LexRequirement</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.eq" class="anchor">§</a>
...
1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#264" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#method.ne" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#method.ne" class="fn">ne</a>(&self, other: <a href="https://doc.rust-lang.org/nightly/std/primitive.reference.html" class="primitive">&amp;Rhs</a>) -\> <a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>

Tests for `!=`. The default implementation is almost always sufficient, and should not be overridden without very good reason.

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#impl-StructuralPartialEq-for-LexRequirement" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html" class="trait" title="trait core::marker::StructuralPartialEq">StructuralPartialEq</a> for <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html" class="struct" title="struct datafusion::physical_expr::LexRequirement">LexRequirement</a>

## Auto Trait Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#synthetic-implementations" class="anchor">§</a>

## Blanket Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexRequirement.html#blanket-implementations" class="anchor">§</a>
