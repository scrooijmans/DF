# Struct SymmetricHashJoinExec Copy item path

<a href="https://docs.rs/datafusion-physical-plan/50.2.0/x86_64-unknown-linux-gnu/src/datafusion_physical_plan/joins/symmetric_hash_join.rs.html#172" class="src">Source</a>
...
- For each new [RecordBatch](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/array/struct.RecordBatch.html "struct datafusion::common::arrow::array::RecordBatch") in build side, hash and insert into inputs hash table. Update offsets.
- Test if input is equal to a predefined set of other inputs.
- If so record the visited rows. If the matched row results must be produced (INNER, LEFT), output the [RecordBatch](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/array/struct.RecordBatch.html "struct datafusion::common::arrow::array::RecordBatch").
- Try to prune other side (probe) with new [RecordBatch](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/array/struct.RecordBatch.html "struct datafusion::common::arrow::array::RecordBatch").
- If the join type indicates that the unmatched rows results must be produced (LEFT, FULL etc.), output the [RecordBatch](https://docs.rs/datafusion/50.2.0/datafusion/common/arrow/array/struct.RecordBatch.html "struct datafusion::common::arrow::array::RecordBatch") when a pruning happens or at the end of the data.
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.join_type" class="fn">join_type</a>(&self) -\> &<a href="https://docs.rs/datafusion/50.2.0/datafusion/prelude/enum.JoinType.html" class="enum" title="enum datafusion::prelude::JoinType">JoinType</a>
...
#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.partition_mode" class="fn">partition_mode</a>(&self) -\> <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/enum.StreamJoinPartitionMode.html" class="enum" title="enum datafusion::physical_plan::joins::StreamJoinPartitionMode">StreamJoinPartitionMode</a>

Get partition mode

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.left_sort_exprs" class="fn">left_sort_exprs</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/core/option/enum.Option.html" class="enum" title="enum core::option::Option">Option</a>\<&<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexOrdering.html" class="struct" title="struct datafusion::physical_expr::LexOrdering">LexOrdering</a>\>

Get left_sort_exprs

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.right_sort_exprs" class="fn">right_sort_exprs</a>(&self) -\> <a href="https://doc.rust-lang.org/nightly/core/option/enum.Option.html" class="enum" title="enum core::option::Option">Option</a>\<&<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_expr/struct.LexOrdering.html" class="struct" title="struct datafusion::physical_expr::LexOrdering">LexOrdering</a>\>

Get right_sort_exprs

#### pub fn <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.check_if_order_information_available" class="fn">check_if_order_information_available</a>( &self, ) -\> <a href="https://doc.rust-lang.org/nightly/core/result/enum.Result.html" class="enum" title="enum core::result::Result">Result</a>\<<a href="https://doc.rust-lang.org/nightly/std/primitive.bool.html" class="primitive">bool</a>, <a href="https://docs.rs/datafusion/50.2.0/datafusion/error/enum.DataFusionError.html" class="enum" title="enum datafusion::error::DataFusionError">DataFusionError</a>\>

Check if order information covers every column in the filter expression.

## Trait Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#trait-implementations" class="anchor">§</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#impl-Clone-for-SymmetricHashJoinExec" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html" class="trait" title="trait core::clone::Clone">Clone</a> for <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html" class="struct" title="struct datafusion::physical_plan::joins::SymmetricHashJoinExec">SymmetricHashJoinExec</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.clone" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone" class="fn">clone</a>(&self) -\> <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html" class="struct" title="struct datafusion::physical_plan::joins::SymmetricHashJoinExec">SymmetricHashJoinExec</a>

Returns a duplicate of the value. [Read more](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)

1.0.0 · <a href="https://doc.rust-lang.org/nightly/src/core/clone.rs.html#245-247" class="src">Source</a><a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.clone_from" class="anchor">§</a>

#### fn <a href="https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#method.clone_from" class="fn">clone_from</a>(&mut self, source: &Self)

Performs copy-assignment from `source`. [Read more](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#method.clone_from)

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#impl-Debug-for-SymmetricHashJoinExec" class="anchor">§</a>

### impl <a href="https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html" class="trait" title="trait core::fmt::Debug">Debug</a> for <a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html" class="struct" title="struct datafusion::physical_plan::joins::SymmetricHashJoinExec">SymmetricHashJoinExec</a>

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.fmt" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#impl-DisplayAs-for-SymmetricHashJoinExec" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.fmt_as" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#impl-ExecutionPlan-for-SymmetricHashJoinExec" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.try_swapping_with_projection" class="anchor">§</a>
...
Tries to swap the projection with its input [`SymmetricHashJoinExec`](https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html "struct datafusion::physical_plan::joins::SymmetricHashJoinExec"). If it can be done, it returns the new swapped version having the [`SymmetricHashJoinExec`](https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html "struct datafusion::physical_plan::joins::SymmetricHashJoinExec") as the top plan. Otherwise, it returns None.

<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.name" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.as_any" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.properties" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.required_input_distribution" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.required_input_ordering" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.children" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.statistics" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.execute" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.static_name" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.schema" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.check_invariants" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.maintains_input_order" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.benefits_from_input_partitioning" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.reset_state" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.repartitioned" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.partition_statistics" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.supports_limit_pushdown" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.with_fetch" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.fetch" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.cardinality_effect" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.gather_filters_for_pushdown" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.handle_child_pushdown_result" class="anchor">§</a>
...
<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#method.with_new_state" class="anchor">§</a>
...
## Auto Trait Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#synthetic-implementations" class="anchor">§</a>

## Blanket Implementations<a href="https://docs.rs/datafusion/50.2.0/datafusion/physical_plan/joins/struct.SymmetricHashJoinExec.html#blanket-implementations" class="anchor">§</a>
