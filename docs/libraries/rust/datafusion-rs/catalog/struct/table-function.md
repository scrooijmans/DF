# TableFunction in datafusion::catalog - Rust

[datafusion](../index.html)::[catalog](index.html)

## Struct TableFunction 

[Source](https://docs.rs/datafusion-catalog/50.2.0/x86_64-unknown-linux-gnu/src/datafusion_catalog/table.rs.html#324)
...
[Source](https://docs.rs/datafusion-catalog/50.2.0/x86_64-unknown-linux-gnu/src/datafusion_catalog/table.rs.html#331)
[§](#impl-TableFunction)

### impl [TableFunction](struct.TableFunction.html "struct datafusion::catalog::TableFunction")

[Source](https://docs.rs/datafusion-catalog/50.2.0/x86_64-unknown-linux-gnu/src/datafusion_catalog/table.rs.html#333)

#### pub fn [new](#method.new)(name: [String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String"), fun: [Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<dyn [TableFunctionImpl](trait.TableFunctionImpl.html "trait datafusion::catalog::TableFunctionImpl")\>) -> [TableFunction](struct.TableFunction.html "struct datafusion::catalog::TableFunction")

Create a new table function

[Source](https://docs.rs/datafusion-catalog/50.2.0/x86_64-unknown-linux-gnu/src/datafusion_catalog/table.rs.html#338)
...
[Source](https://docs.rs/datafusion-catalog/50.2.0/x86_64-unknown-linux-gnu/src/datafusion_catalog/table.rs.html#343)

#### pub fn [function](#method.function)(&self) -> &[Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<dyn [TableFunctionImpl](trait.TableFunctionImpl.html "trait datafusion::catalog::TableFunctionImpl")\>

Get the implementation of the table function

[Source](https://docs.rs/datafusion-catalog/50.2.0/x86_64-unknown-linux-gnu/src/datafusion_catalog/table.rs.html#348)

#### pub fn [create_table_provider](#method.create_table_provider)( &self, args: &\[[Expr](../prelude/enum.Expr.html "enum datafusion::prelude::Expr")\], ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<dyn [TableProvider](../datasource/trait.TableProvider.html "trait datafusion::datasource::TableProvider")\>, [DataFusionError](../error/enum.DataFusionError.html "enum datafusion::error::DataFusionError")\>

Get the function implementation and generate a table

## Trait Implementations[§](#trait-implementations)

[Source](https://docs.rs/datafusion-catalog/50.2.0/x86_64-unknown-linux-gnu/src/datafusion_catalog/table.rs.html#323)
[§](#impl-Debug-for-TableFunction)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [TableFunction](struct.TableFunction.html "struct datafusion::catalog::TableFunction")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TableFunction](struct.TableFunction.html "struct datafusion::catalog::TableFunction")

[§](#impl-RefUnwindSafe-for-TableFunction)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TableFunction](struct.TableFunction.html "struct datafusion::catalog::TableFunction")

[§](#impl-Send-for-TableFunction)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TableFunction](struct.TableFunction.html "struct datafusion::catalog::TableFunction")

[§](#impl-Sync-for-TableFunction)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TableFunction](struct.TableFunction.html "struct datafusion::catalog::TableFunction")

[§](#impl-Unpin-for-TableFunction)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TableFunction](struct.TableFunction.html "struct datafusion::catalog::TableFunction")

[§](#impl-UnwindSafe-for-TableFunction)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TableFunction](struct.TableFunction.html "struct datafusion::catalog::TableFunction")
