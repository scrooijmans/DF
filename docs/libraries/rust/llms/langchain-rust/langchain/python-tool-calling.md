...
If desired, [output parsers](about:/docs/how_to/#output-parsers) can further process the output. For example, we can convert back to the original Pydantic class:
...
*   **Tool use**: See how to construct chains and agents that call the invoked tools in [these guides](about:/docs/how_to/#tools).