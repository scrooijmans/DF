# ObjectResponse in supabase_storage_rs::models - Rust

[supabase_storage_rs](../index.html)::[models](index.html)

## Struct ObjectResponse

[Source](about:blank/src/supabase_storage_rs/models.rs.html#237-242)
...
[§](#structfield.id)`id: [String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String")`[§](#structfield.key)`key: [String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String")`

## Trait Implementations[§](#trait-implementations)

[Source](about:blank/src/supabase_storage_rs/models.rs.html#236)
[§](#impl-Clone-for-ObjectResponse)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ObjectResponse](struct.ObjectResponse.html "struct supabase_storage_rs::models::ObjectResponse")

[Source](about:blank/src/supabase_storage_rs/models.rs.html#236)
[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ObjectResponse](struct.ObjectResponse.html "struct supabase_storage_rs::models::ObjectResponse")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ObjectResponse](struct.ObjectResponse.html "struct supabase_storage_rs::models::ObjectResponse")
...
[Source](about:blank/src/supabase_storage_rs/models.rs.html#236)
[§](#impl-Deserialize%3C'de%3E-for-ObjectResponse)

### impl<'de> [Deserialize](https://docs.rs/serde/1.0.215/x86_64-unknown-linux-gnu/serde/de/trait.Deserialize.html "trait serde::de::Deserialize")<'de> for [ObjectResponse](struct.ObjectResponse.html "struct supabase_storage_rs::models::ObjectResponse")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [ObjectResponse](struct.ObjectResponse.html "struct supabase_storage_rs::models::ObjectResponse")

[Source](about:blank/src/supabase_storage_rs/models.rs.html#236)
[§](#method.eq)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[ObjectResponse](struct.ObjectResponse.html "struct supabase_storage_rs::models::ObjectResponse")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [Serialize](https://docs.rs/serde/1.0.215/x86_64-unknown-linux-gnu/serde/ser/trait.Serialize.html "trait serde::ser::Serialize") for [ObjectResponse](struct.ObjectResponse.html "struct supabase_storage_rs::models::ObjectResponse")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [ObjectResponse](struct.ObjectResponse.html "struct supabase_storage_rs::models::ObjectResponse")

## Auto Trait Implementations[§](#synthetic-implementations)

[§](#impl-Freeze-for-ObjectResponse)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ObjectResponse](struct.ObjectResponse.html "struct supabase_storage_rs::models::ObjectResponse")

[§](#impl-RefUnwindSafe-for-ObjectResponse)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ObjectResponse](struct.ObjectResponse.html "struct supabase_storage_rs::models::ObjectResponse")

[§](#impl-Send-for-ObjectResponse)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ObjectResponse](struct.ObjectResponse.html "struct supabase_storage_rs::models::ObjectResponse")

[§](#impl-Sync-for-ObjectResponse)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ObjectResponse](struct.ObjectResponse.html "struct supabase_storage_rs::models::ObjectResponse")

[§](#impl-Unpin-for-ObjectResponse)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ObjectResponse](struct.ObjectResponse.html "struct supabase_storage_rs::models::ObjectResponse")

[§](#impl-UnwindSafe-for-ObjectResponse)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ObjectResponse](struct.ObjectResponse.html "struct supabase_storage_rs::models::ObjectResponse")
