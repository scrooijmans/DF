# Bucket in supabase_storage_rs::models - Rust

[supabase_storage_rs](../index.html)::[models](index.html)

## Struct Bucket

[Source](about:blank/src/supabase_storage_rs/models.rs.html#223-234)
...
[§](#structfield.id)`id: [String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String")`[§](#structfield.name)`name: [String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String")`[§](#structfield.owner)`owner: [String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String")`[§](#structfield.public)`public: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`[§](#structfield.file_size_limit)`file_size_limit: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[i64](https://doc.rust-lang.org/nightly/std/primitive.i64.html)>`[§](#structfield.allowed_mime_types)`allowed_mime_types: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Vec](https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html "struct alloc::vec::Vec")<[String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String")>>`[§](#structfield.created_at)`created_at: [String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String")`[§](#structfield.updated_at)`updated_at: [String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String")`

## Trait Implementations[§](#trait-implementations)

[Source](about:blank/src/supabase_storage_rs/models.rs.html#222)
[§](#impl-Clone-for-Bucket)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Bucket](struct.Bucket.html "struct supabase_storage_rs::models::Bucket")

[Source](about:blank/src/supabase_storage_rs/models.rs.html#222)
[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Bucket](struct.Bucket.html "struct supabase_storage_rs::models::Bucket")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Bucket](struct.Bucket.html "struct supabase_storage_rs::models::Bucket")
...
[Source](about:blank/src/supabase_storage_rs/models.rs.html#222)
[§](#impl-Deserialize%3C'de%3E-for-Bucket)

### impl<'de> [Deserialize](https://docs.rs/serde/1.0.215/x86_64-unknown-linux-gnu/serde/de/trait.Deserialize.html "trait serde::de::Deserialize")<'de> for [Bucket](struct.Bucket.html "struct supabase_storage_rs::models::Bucket")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Bucket](struct.Bucket.html "struct supabase_storage_rs::models::Bucket")

[Source](about:blank/src/supabase_storage_rs/models.rs.html#222)
[§](#method.eq)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Bucket](struct.Bucket.html "struct supabase_storage_rs::models::Bucket")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [Serialize](https://docs.rs/serde/1.0.215/x86_64-unknown-linux-gnu/serde/ser/trait.Serialize.html "trait serde::ser::Serialize") for [Bucket](struct.Bucket.html "struct supabase_storage_rs::models::Bucket")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Bucket](struct.Bucket.html "struct supabase_storage_rs::models::Bucket")

## Auto Trait Implementations[§](#synthetic-implementations)

[§](#impl-Freeze-for-Bucket)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Bucket](struct.Bucket.html "struct supabase_storage_rs::models::Bucket")

[§](#impl-RefUnwindSafe-for-Bucket)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Bucket](struct.Bucket.html "struct supabase_storage_rs::models::Bucket")

[§](#impl-Send-for-Bucket)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Bucket](struct.Bucket.html "struct supabase_storage_rs::models::Bucket")

[§](#impl-Sync-for-Bucket)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Bucket](struct.Bucket.html "struct supabase_storage_rs::models::Bucket")

[§](#impl-Unpin-for-Bucket)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Bucket](struct.Bucket.html "struct supabase_storage_rs::models::Bucket")

[§](#impl-UnwindSafe-for-Bucket)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Bucket](struct.Bucket.html "struct supabase_storage_rs::models::Bucket")
