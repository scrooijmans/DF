Title: Windows Code Signing | Tauri
...
Section titled “OV Certificates”
...
Section titled “Convert your .cer to .pfx”
...
Section titled “Import your .pfx file into the keystore.”
...
Section titled “Prepare Variables”
...
Section titled “Prepare tauri.conf.json file”
...
Section titled “Sign your application with GitHub Actions.”

We can also create a workflow to sign the application with GitHub actions.

#### GitHub Secrets

Section titled “GitHub Secrets”
...
Section titled “Workflow Modifications”
...
Section titled “Azure Key Vault”
...
Note that you must replace <KEY\_VAULT\_NAME> and <CERTIFICATE\_NAME> with the appropriate names from the previous steps.
...
Section titled “Custom Sign Command”
...
Section titled “Azure Code Signing”
...
Section titled “Install trusted-signing-cli”
...
Section titled “Modify your tauri.conf.json file”
...
```
{  "bundle": {    "windows": {      "signCommand": "trusted-signing-cli -e https://wus2.codesigning.azure.net -a MyAccount -c MyProfile -d MyApp %1"    }  }}
```
