# Complete guide to logging with Tauri - Aptabase
...
- **Log file**, located on the user’s home directory. [Where to find log files from Tauri Apps?](https://aptabase.com/blog/where-to-find-tauri-logs);
...
![Screenshot of Tauri DevTools showing logs from Rust](https://aptabase.com/_astro/rust-logs-on-devtools.4fae1d32_1ptcRX.webp)
