...
- Enables you to easily use various components like [Select](https://shadcn-svelte.com/docs/components/select), [RadioGroup](https://shadcn-svelte.com/docs/components/radio-group), [Switch](https://shadcn-svelte.com/docs/components/switch), [Checkbox](https://shadcn-svelte.com/docs/components/checkbox) and other form components with forms.
...
- [Checkbox](about:/docs/components/checkbox#form)
- [Date Picker](about:/docs/components/date-picker#form)
- [Input](about:/docs/components/input#form)
- [Radio Group](about:/docs/components/radio-group#form)
- [Select](about:/docs/components/select#form)
- [Switch](about:/docs/components/switch#form)
- [Textarea](about:/docs/components/textarea#form)
